...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Integer Binary Expression</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link activitydiagram.impl.IntegerBinaryExpressionImpl#getOperand1 <em>Operand1</em>}</li>
 *   <li>{@link activitydiagram.impl.IntegerBinaryExpressionImpl#getOperand2 <em>Operand2</em>}</li>
 *   <li>{@link activitydiagram.impl.IntegerBinaryExpressionImpl#getOperator <em>Operator</em>}</li>
 * </ul>
 *
 * @generated
 */
public class IntegerBinaryExpressionImpl extends ExpressionImpl implements IntegerBinaryExpression {
	/**
	 ...
	 * @generated
	 */
	protected IntegerBinaryExpressionImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return ActivitydiagramPackage.Literals.INTEGER_BINARY_EXPRESSION;
	}
		...
		if (operand2 != null && operand2.eIsProxy()) {
			...
			if (operand2 != oldOperand2) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ActivitydiagramPackage.INTEGER_BINARY_EXPRESSION__OPERAND2, oldOperand2, operand2));
			}
		}
		return operand2;
	}
	...
	public void setOperand2(IntegerExpression newOperand2) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ActivitydiagramPackage.INTEGER_BINARY_EXPRESSION__OPERAND2, oldOperand2, operand2));
	}
	...
	public IntegerExpression getOperand1() {
		if (operand1 != null && operand1.eIsProxy()) {
			...
			if (operand1 != oldOperand1) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ActivitydiagramPackage.INTEGER_BINARY_EXPRESSION__OPERAND1, oldOperand1, operand1));
			}
		}
		return operand1;
	}
	...
	public void setOperand1(IntegerExpression newOperand1) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ActivitydiagramPackage.INTEGER_BINARY_EXPRESSION__OPERAND1, oldOperand1, operand1));
	}
	...
	public void setOperator(IntegerCalculationOperator newOperator) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ActivitydiagramPackage.INTEGER_BINARY_EXPRESSION__OPERATOR, oldOperator, operator));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ActivitydiagramPackage.INTEGER_BINARY_EXPRESSION__OPERAND1:
				if (resolve) return getOperand1();
				return basicGetOperand1();
			case ActivitydiagramPackage.INTEGER_BINARY_EXPRESSION__OPERAND2:
