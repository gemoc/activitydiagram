 ...
 * </p>
 * <ul>
 *   <li>{@link activitydiagram.impl.OpaqueActionImpl#getAssignments <em>Assignments</em>}</li>
 * </ul>
 *
 * @generated
 */
public class OpaqueActionImpl extends ActionImpl implements OpaqueAction {
	...
	public EList<VariableAssignment> getAssignments() {
		if (assignments == null) {
			assignments = new EObjectContainmentEList<VariableAssignment>(VariableAssignment.class, this, ActivitydiagramPackage.OPAQUE_ACTION__ASSIGNMENTS);
		}
		return assignments;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ActivitydiagramPackage.OPAQUE_ACTION__ASSIGNMENTS:
