		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getActivityAccess().getNodesAssignment_5_2(), "rule__Activity__NodesAssignment_5_2");
					put(grammarAccess.getActivityAccess().getNodesAssignment_5_3_1(), "rule__Activity__NodesAssignment_5_3_1");
					put(grammarAccess.getActivityAccess().getEdgesAssignment_6_2(), "rule__Activity__EdgesAssignment_6_2");
					put(grammarAccess.getActivityAccess().getEdgesAssignment_6_3_1(), "rule__Activity__EdgesAssignment_6_3_1");
