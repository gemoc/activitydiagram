...
public class ActivitydiagramFactoryImpl extends EFactoryImpl implements ActivitydiagramFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			...
			case ActivitydiagramPackage.TRACED_FLOW_FINAL_NODE: return createTracedFlowFinalNode();
			...
			case ActivitydiagramPackage.TRACED_INTEGER_BINARY_EXPRESSION: return createTracedIntegerBinaryExpression();
	 ...
	 * @generated
	 */
	public TracedBooleanBinaryExpression createTracedBooleanBinaryExpression() {
		TracedBooleanBinaryExpressionImpl tracedBooleanBinaryExpression = new TracedBooleanBinaryExpressionImpl();
		return tracedBooleanBinaryExpression;
	}
	 ...
	 * @generated
	 */
	public TracedFlowFinalNode createTracedFlowFinalNode() {
		TracedFlowFinalNodeImpl tracedFlowFinalNode = new TracedFlowFinalNodeImpl();
		return tracedFlowFinalNode;
	}
	 ...
	 * @generated
	 */
	public TracedIntegerBinaryExpression createTracedIntegerBinaryExpression() {
		TracedIntegerBinaryExpressionImpl tracedIntegerBinaryExpression = new TracedIntegerBinaryExpressionImpl();
		return tracedIntegerBinaryExpression;
	}
