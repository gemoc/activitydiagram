...
public class StepsSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case StepsPackage.ACTIVITYDIAGRAM_ACTIVITY_NODE_ADD_TOKEN: {
				...
				if (result == null) result = caseActivitydiagram_Activity_Execute_AbstractSubStep(activitydiagram_ActivityNode_AddToken);
				if (result == null) result = caseActivitydiagram_ActivityNode_Execute_AbstractSubStep(activitydiagram_ActivityNode_AddToken);
			...
			case StepsPackage.ACTIVITYDIAGRAM_ACTIVITY_NODE_REMOVE_TOKEN: {
				Activitydiagram_ActivityNode_RemoveToken activitydiagram_ActivityNode_RemoveToken = (Activitydiagram_ActivityNode_RemoveToken)theEObject;
				T result = caseActivitydiagram_ActivityNode_RemoveToken(activitydiagram_ActivityNode_RemoveToken);
				if (result == null) result = caseSpecificStep(activitydiagram_ActivityNode_RemoveToken);
				if (result == null) result = caseSmallStep(activitydiagram_ActivityNode_RemoveToken);
				if (result == null) result = caseStep(activitydiagram_ActivityNode_RemoveToken);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Activitydiagram Activity Node Remove Token</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Activitydiagram Activity Node Remove Token</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseActivitydiagram_ActivityNode_RemoveToken(Activitydiagram_ActivityNode_RemoveToken object) {
		return null;
	}
