 ...
 * </p>
 * <ul>
 *   <li>{@link org.gemoc.activitydiagram.sequential.xactivitydiagram.activitydiagram.impl.BooleanUnaryExpressionImpl#getOperand <em>Operand</em>}</li>
 *   <li>{@link org.gemoc.activitydiagram.sequential.xactivitydiagram.activitydiagram.impl.BooleanUnaryExpressionImpl#getOperator <em>Operator</em>}</li>
 * </ul>
 *
 * @generated
 */
public class BooleanUnaryExpressionImpl extends BooleanExpressionImpl implements BooleanUnaryExpression {
	...
	public BooleanExpression getOperand() {
		if (operand != null && operand.eIsProxy()) {
			...
			operand = (BooleanExpression)eResolveProxy(oldOperand);
	 ...
	 * @generated
	 */
	public BooleanExpression basicGetOperand() {
		return operand;
	}
