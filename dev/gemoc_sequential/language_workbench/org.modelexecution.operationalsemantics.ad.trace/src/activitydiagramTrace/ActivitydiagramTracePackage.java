...
public interface ActivitydiagramTracePackage extends EPackage {
	 ...
	 * @ordered
	 */
	int STATE__TOKEN_HOLDER_VALUES = 3;
	 ...
	 * @ordered
	 */
	int STATE__INPUT_INPUT_VALUES_VALUES = 4;
	 ...
	 * @ordered
	 */
	int STATE__ACTIVITY_NODE_HELD_TOKENS_VALUES = 7;
	 ...
	 * @ordered
	 */
	int STATE__INTEGER_VALUE_VALUE_VALUES = 8;
	 ...
	 * @ordered
	 */
	int STATE__ACTIVITY_EDGE_OFFERS_VALUES = 9;
	 ...
	 * @ordered
	 */
	int STATE__INPUT_VALUE_VALUE_VALUES = 11;
	 ...
	 * @ordered
	 */
	int STATE__INPUT_VALUE_VARIABLE_VALUES = 12;
	 ...
	 * @ordered
	 */
	int STATE__VARIABLE_CURRENT_VALUE_VALUES = 13;
	 ...
	 * @ordered
	 */
	int STATE__ACTIVITY_TRACE_VALUES = 15;
	 ...
	 * @ordered
	 */
	int STATE__TRACE_EXECUTED_NODES_VALUES = 16;
