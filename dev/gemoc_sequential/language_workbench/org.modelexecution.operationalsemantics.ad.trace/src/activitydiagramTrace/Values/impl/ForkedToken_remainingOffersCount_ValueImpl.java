 ...
 * <ul>
 *   <li>{@link activitydiagramTrace.Values.impl.ForkedToken_remainingOffersCount_ValueImpl#getRemainingOffersCount <em>Remaining Offers Count</em>}</li>
 *   <li>{@link activitydiagramTrace.Values.impl.ForkedToken_remainingOffersCount_ValueImpl#getParent <em>Parent</em>}</li>
 *   <li>{@link activitydiagramTrace.Values.impl.ForkedToken_remainingOffersCount_ValueImpl#getStates <em>States</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ForkedToken_remainingOffersCount_ValueImpl extends MinimalEObjectImpl.Container implements ForkedToken_remainingOffersCount_Value {
	...
	protected EClass eStaticClass() {
		return ValuesPackage.Literals.FORKED_TOKEN_REMAINING_OFFERS_COUNT_VALUE;
	}
	...
	public void setRemainingOffersCount(int newRemainingOffersCount) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ValuesPackage.FORKED_TOKEN_REMAINING_OFFERS_COUNT_VALUE__REMAINING_OFFERS_COUNT, oldRemainingOffersCount, remainingOffersCount));
	}
	...
	public TracedForkedToken getParent() {
		if (eContainerFeatureID() != ValuesPackage.FORKED_TOKEN_REMAINING_OFFERS_COUNT_VALUE__PARENT) return null;
	...
	public NotificationChain basicSetParent(TracedForkedToken newParent, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject)newParent, ValuesPackage.FORKED_TOKEN_REMAINING_OFFERS_COUNT_VALUE__PARENT, msgs);
		return msgs;
	}
	...
	public void setParent(TracedForkedToken newParent) {
		if (newParent != eInternalContainer() || (eContainerFeatureID() != ValuesPackage.FORKED_TOKEN_REMAINING_OFFERS_COUNT_VALUE__PARENT && newParent != null)) {
			...
			if (newParent != null)
				msgs = ((InternalEObject)newParent).eInverseAdd(this, ActivitydiagramPackage.TRACED_FORKED_TOKEN__REMAINING_OFFERS_COUNT_TRACE, TracedForkedToken.class, msgs);
			msgs = basicSetParent(newParent, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ValuesPackage.FORKED_TOKEN_REMAINING_OFFERS_COUNT_VALUE__PARENT, newParent, newParent));
	}
	...
	public EList<State> getStates() {
		if (states == null) {
			states = new EObjectWithInverseResolvingEList.ManyInverse<State>(State.class, this, ValuesPackage.FORKED_TOKEN_REMAINING_OFFERS_COUNT_VALUE__STATES, ActivitydiagramTracePackage.STATE__FORKED_TOKEN_REMAINING_OFFERS_COUNT_VALUES);
		}
		return states;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ValuesPackage.FORKED_TOKEN_REMAINING_OFFERS_COUNT_VALUE__PARENT:
				if (eInternalContainer() != null)
					msgs = eBasicRemoveFromContainer(msgs);
				return basicSetParent((TracedForkedToken)otherEnd, msgs);
			case ValuesPackage.FORKED_TOKEN_REMAINING_OFFERS_COUNT_VALUE__STATES:
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		switch (eContainerFeatureID()) {
			case ValuesPackage.FORKED_TOKEN_REMAINING_OFFERS_COUNT_VALUE__PARENT:
				return eInternalContainer().eInverseRemove(this, ActivitydiagramPackage.TRACED_FORKED_TOKEN__REMAINING_OFFERS_COUNT_TRACE, TracedForkedToken.class, msgs);
		}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ValuesPackage.FORKED_TOKEN_REMAINING_OFFERS_COUNT_VALUE__REMAINING_OFFERS_COUNT:
