 ...
 */
package org.gemoc.activitydiagram.sequential.xactivitydiagram.input.services;
...
public class ActivityDiagramInputGrammarAccess extends AbstractGrammarElementFinder {
	...
	public class InputElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.gemoc.activitydiagram.sequential.xactivitydiagram.input.ActivityDiagramInput.Input");
		private final Assignment cInputValuesAssignment = (Assignment)rule.eContents().get(1);
		private final RuleCall cInputValuesInputValueParserRuleCall_0 = (RuleCall)cInputValuesAssignment.eContents().get(0);
		...
		//inputValues+=InputValue
		public Assignment getInputValuesAssignment() { return cInputValuesAssignment; }
		
		//InputValue
		public RuleCall getInputValuesInputValueParserRuleCall_0() { return cInputValuesInputValueParserRuleCall_0; }
	}
	public class InputValueElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.gemoc.activitydiagram.sequential.xactivitydiagram.input.ActivityDiagramInput.InputValue");
	...
	public class ValueElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.gemoc.activitydiagram.sequential.xactivitydiagram.input.ActivityDiagramInput.Value");
	...
	public class BooleanValueElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.gemoc.activitydiagram.sequential.xactivitydiagram.input.ActivityDiagramInput.BooleanValue");
	...
	public class IntegerValueElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.gemoc.activitydiagram.sequential.xactivitydiagram.input.ActivityDiagramInput.IntegerValue");
		private final Assignment cValueAssignment = (Assignment)rule.eContents().get(1);
	...
	public class EBooleanElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.gemoc.activitydiagram.sequential.xactivitydiagram.input.ActivityDiagramInput.EBoolean");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
	...
	public class EIntElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.gemoc.activitydiagram.sequential.xactivitydiagram.input.ActivityDiagramInput.EInt");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class EStringElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.gemoc.activitydiagram.sequential.xactivitydiagram.input.ActivityDiagramInput.EString");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
	...
	protected Grammar internalFindGrammar(GrammarProvider grammarProvider) {
		...
		while (grammar != null) {
			if ("org.gemoc.activitydiagram.sequential.xactivitydiagram.input.ActivityDiagramInput".equals(grammar.getName())) {
				return grammar;
			}
