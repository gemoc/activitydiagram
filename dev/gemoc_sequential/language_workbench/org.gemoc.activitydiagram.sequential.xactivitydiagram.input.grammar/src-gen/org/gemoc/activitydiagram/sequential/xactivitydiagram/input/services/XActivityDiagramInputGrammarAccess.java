...
@Singleton
public class XActivityDiagramInputGrammarAccess extends AbstractGrammarElementFinder {
	
	public class InputElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.gemoc.activitydiagram.sequential.xactivitydiagram.input.XActivityDiagramInput.Input");
		...
		//Input:
		//	{Input} inputValues+=InputValue ("," inputValues+=InputValue)*;
	...
	public class InputValueElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.gemoc.activitydiagram.sequential.xactivitydiagram.input.XActivityDiagramInput.InputValue");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class ValueElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.gemoc.activitydiagram.sequential.xactivitydiagram.input.XActivityDiagramInput.Value");
	...
	public class BooleanValueElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.gemoc.activitydiagram.sequential.xactivitydiagram.input.XActivityDiagramInput.BooleanValue");
	...
	public class IntegerValueElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.gemoc.activitydiagram.sequential.xactivitydiagram.input.XActivityDiagramInput.IntegerValue");
		private final Assignment cValueAssignment = (Assignment)rule.eContents().get(1);
	...
	public class EBooleanElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.gemoc.activitydiagram.sequential.xactivitydiagram.input.XActivityDiagramInput.EBoolean");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
	...
	public class EIntElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.gemoc.activitydiagram.sequential.xactivitydiagram.input.XActivityDiagramInput.EInt");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class EStringElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.gemoc.activitydiagram.sequential.xactivitydiagram.input.XActivityDiagramInput.EString");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
	...
	@Inject
	public XActivityDiagramInputGrammarAccess(GrammarProvider grammarProvider,
	...
	protected Grammar internalFindGrammar(GrammarProvider grammarProvider) {
		...
		while (grammar != null) {
			if ("org.gemoc.activitydiagram.sequential.xactivitydiagram.input.XActivityDiagramInput".equals(grammar.getName())) {
				return grammar;
			}
