...
public class ActivityDiagramGrammarAccess extends AbstractGrammarElementFinder {
	...
	public class ValueElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.gemoc.activitydiagram.sequential.xactivitydiagram.ActivityDiagram.Value");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
		private final RuleCall cStaticBooleanValueParserRuleCall_0 = (RuleCall)cAlternatives.eContents().get(0);
		private final RuleCall cStaticIntegerValueParserRuleCall_1 = (RuleCall)cAlternatives.eContents().get(1);
		
		//Value:
		//	StaticBooleanValue | StaticIntegerValue;
		@Override public ParserRule getRule() { return rule; }
		...
		//StaticBooleanValue
		public RuleCall getStaticBooleanValueParserRuleCall_0() { return cStaticBooleanValueParserRuleCall_0; }
		
		//StaticIntegerValue
		public RuleCall getStaticIntegerValueParserRuleCall_1() { return cStaticIntegerValueParserRuleCall_1; }
	}
	...
	public class IntegerCalculationExpressionElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.gemoc.activitydiagram.sequential.xactivitydiagram.ActivityDiagram.IntegerCalculationExpression");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class IntegerVariableElements extends AbstractParserRuleElementFinder {
		...
		private final Assignment cCurrentValueAssignment_4 = (Assignment)cGroup.eContents().get(4);
		private final RuleCall cCurrentValueDynamicIntegerValueParserRuleCall_4_0 = (RuleCall)cCurrentValueAssignment_4.eContents().get(0);
		
		//IntegerVariable:
		//	{IntegerVariable}
		//	'int'
		//	name=EString ('=' initialValue=Value)?
		//	currentValue=DynamicIntegerValue;
		@Override public ParserRule getRule() { return rule; }
		
		//{IntegerVariable} 'int' name=EString ('=' initialValue=Value)? currentValue=DynamicIntegerValue
		public Group getGroup() { return cGroup; }
		...
		//currentValue=DynamicIntegerValue
		public Assignment getCurrentValueAssignment_4() { return cCurrentValueAssignment_4; }
		
		//DynamicIntegerValue
		public RuleCall getCurrentValueDynamicIntegerValueParserRuleCall_4_0() { return cCurrentValueDynamicIntegerValueParserRuleCall_4_0; }
	}
	public class BooleanVariableElements extends AbstractParserRuleElementFinder {
		...
		private final RuleCall cInitialValueValueParserRuleCall_3_1_0 = (RuleCall)cInitialValueAssignment_3_1.eContents().get(0);
		private final Assignment cCurrentValueAssignment_4 = (Assignment)cGroup.eContents().get(4);
		private final RuleCall cCurrentValueDynamicBooleanValueParserRuleCall_4_0 = (RuleCall)cCurrentValueAssignment_4.eContents().get(0);
		
		//BooleanVariable:
		//	{BooleanVariable}
		//	'bool'
		//	name=EString ('=' initialValue=Value)?
		//	currentValue=DynamicBooleanValue;
		@Override public ParserRule getRule() { return rule; }
		
		//{BooleanVariable} 'bool' name=EString ('=' initialValue=Value)? currentValue=DynamicBooleanValue
		public Group getGroup() { return cGroup; }
		...
		//DynamicBooleanValue
		public RuleCall getCurrentValueDynamicBooleanValueParserRuleCall_4_0() { return cCurrentValueDynamicBooleanValueParserRuleCall_4_0; }
	}
	public class StaticBooleanValueElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.gemoc.activitydiagram.sequential.xactivitydiagram.ActivityDiagram.StaticBooleanValue");
	...
	public class StaticIntegerValueElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.gemoc.activitydiagram.sequential.xactivitydiagram.ActivityDiagram.StaticIntegerValue");
		private final Assignment cValueAssignment = (Assignment)rule.eContents().get(1);
	...
	public class DynamicIntegerValueElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.gemoc.activitydiagram.sequential.xactivitydiagram.ActivityDiagram.DynamicIntegerValue");
		private final Action cDynamicIntegerValueAction = (Action)rule.eContents().get(1);
		...
		//{DynamicIntegerValue}
		public Action getDynamicIntegerValueAction() { return cDynamicIntegerValueAction; }
	}
	public class DynamicBooleanValueElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.gemoc.activitydiagram.sequential.xactivitydiagram.ActivityDiagram.DynamicBooleanValue");
		private final Action cDynamicBooleanValueAction = (Action)rule.eContents().get(1);
		...
		//{DynamicBooleanValue}
		public Action getDynamicBooleanValueAction() { return cDynamicBooleanValueAction; }
	}
	...
	private final StaticBooleanValueElements pStaticBooleanValue;
	private final StaticIntegerValueElements pStaticIntegerValue;
	private final DynamicIntegerValueElements pDynamicIntegerValue;
	private final DynamicBooleanValueElements pDynamicBooleanValue;
	...
	public ActivityDiagramGrammarAccess(GrammarProvider grammarProvider,
		...
		this.pStaticBooleanValue = new StaticBooleanValueElements();
		this.pStaticIntegerValue = new StaticIntegerValueElements();
		this.pDynamicIntegerValue = new DynamicIntegerValueElements();
		this.pDynamicBooleanValue = new DynamicBooleanValueElements();
	...
	//StaticBooleanValue:
	//	value=EBoolean;
	public StaticBooleanValueElements getStaticBooleanValueAccess() {
		return pStaticBooleanValue;
	}
	
	public ParserRule getStaticBooleanValueRule() {
		return getStaticBooleanValueAccess().getRule();
	}
	
	//StaticIntegerValue:
	//	value=EInt;
	public StaticIntegerValueElements getStaticIntegerValueAccess() {
		return pStaticIntegerValue;
	}
	
	public ParserRule getStaticIntegerValueRule() {
		return getStaticIntegerValueAccess().getRule();
	}
	
	//DynamicIntegerValue:
	//	{DynamicIntegerValue};
	public DynamicIntegerValueElements getDynamicIntegerValueAccess() {
		return pDynamicIntegerValue;
	}
	
	public ParserRule getDynamicIntegerValueRule() {
		return getDynamicIntegerValueAccess().getRule();
	}
	
	//DynamicBooleanValue:
	//	{DynamicBooleanValue};
	public DynamicBooleanValueElements getDynamicBooleanValueAccess() {
		return pDynamicBooleanValue;
	}
	
	public ParserRule getDynamicBooleanValueRule() {
		return getDynamicBooleanValueAccess().getRule();
	}
