...
public class ActivityDiagramSemanticSequencer extends AbstractDelegatingSemanticSequencer {
	...
	public void sequence(ISerializationContext context, EObject semanticObject) {
		...
		if (epackage == ActivitydiagramPackage.eINSTANCE)
			...
			case ActivitydiagramPackage.DYNAMIC_BOOLEAN_VALUE:
				sequence_DynamicBooleanValue(context, (DynamicBooleanValue) semanticObject); 
				return; 
			case ActivitydiagramPackage.DYNAMIC_INTEGER_VALUE:
				sequence_DynamicIntegerValue(context, (DynamicIntegerValue) semanticObject); 
				return; 
			...
			case ActivitydiagramPackage.STATIC_BOOLEAN_VALUE:
				sequence_StaticBooleanValue(context, (StaticBooleanValue) semanticObject); 
				return; 
			case ActivitydiagramPackage.STATIC_INTEGER_VALUE:
				sequence_StaticIntegerValue(context, (StaticIntegerValue) semanticObject); 
				return; 
			}
	 ...
	 *
	 * Constraint:
	 *     (name=EString initialValue=Value? currentValue=DynamicBooleanValue)
	 */
	...
	/**
	 * Contexts:
	 *     DynamicBooleanValue returns DynamicBooleanValue
	 *
	 * Constraint:
	 *     {DynamicBooleanValue}
	 */
	protected void sequence_DynamicBooleanValue(ISerializationContext context, DynamicBooleanValue semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
	...
	/**
	 * Contexts:
	 *     DynamicIntegerValue returns DynamicIntegerValue
	 *
	 * Constraint:
	 *     {DynamicIntegerValue}
	 */
	protected void sequence_DynamicIntegerValue(ISerializationContext context, DynamicIntegerValue semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
	 ...
	 *
	 * Constraint:
	 *     (name=EString initialValue=Value? currentValue=DynamicIntegerValue)
	 */
	...
	/**
	 * Contexts:
	 *     Value returns StaticBooleanValue
	 *     StaticBooleanValue returns StaticBooleanValue
	 *
	 * Constraint:
	 *     value=EBoolean
	 */
	protected void sequence_StaticBooleanValue(ISerializationContext context, StaticBooleanValue semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, ActivitydiagramPackage.Literals.STATIC_BOOLEAN_VALUE__VALUE) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, ActivitydiagramPackage.Literals.STATIC_BOOLEAN_VALUE__VALUE));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getStaticBooleanValueAccess().getValueEBooleanParserRuleCall_0(), semanticObject.isValue());
		feeder.finish();
	}
	...
	/**
	 * Contexts:
	 *     Value returns StaticIntegerValue
	 *     StaticIntegerValue returns StaticIntegerValue
	 *
	 * Constraint:
	 *     value=EInt
	 */
	protected void sequence_StaticIntegerValue(ISerializationContext context, StaticIntegerValue semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, ActivitydiagramPackage.Literals.STATIC_INTEGER_VALUE__VALUE) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, ActivitydiagramPackage.Literals.STATIC_INTEGER_VALUE__VALUE));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getStaticIntegerValueAccess().getValueEIntParserRuleCall_0(), semanticObject.getValue());
		feeder.finish();
	}
