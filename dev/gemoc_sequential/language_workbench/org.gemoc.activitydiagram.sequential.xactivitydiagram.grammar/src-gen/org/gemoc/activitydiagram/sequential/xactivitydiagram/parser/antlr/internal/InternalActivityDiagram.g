...
@after {
	...
	(
		...
		{
			$current = $this_StaticBooleanValue_0.current;
			afterParserOrEnumRuleCall();
		}
		    |
		{
		...
		{
			$current = $this_StaticIntegerValue_1.current;
			afterParserOrEnumRuleCall();
		}
	)
;
...
// Entry rule entryRuleStaticBooleanValue
entryRuleStaticBooleanValue returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getStaticBooleanValueRule()); }
	iv_ruleStaticBooleanValue=ruleStaticBooleanValue
	{ $current=$iv_ruleStaticBooleanValue.current; }
	EOF;

// Rule StaticBooleanValue
ruleStaticBooleanValue returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
// Entry rule entryRuleStaticIntegerValue
entryRuleStaticIntegerValue returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getStaticIntegerValueRule()); }
	iv_ruleStaticIntegerValue=ruleStaticIntegerValue
	{ $current=$iv_ruleStaticIntegerValue.current; }
	EOF;

// Rule StaticIntegerValue
ruleStaticIntegerValue returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
// Entry rule entryRuleDynamicIntegerValue
entryRuleDynamicIntegerValue returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getDynamicIntegerValueRule()); }
	iv_ruleDynamicIntegerValue=ruleDynamicIntegerValue
	{ $current=$iv_ruleDynamicIntegerValue.current; }
	EOF;

// Rule DynamicIntegerValue
ruleDynamicIntegerValue returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
// Entry rule entryRuleDynamicBooleanValue
entryRuleDynamicBooleanValue returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getDynamicBooleanValueRule()); }
	iv_ruleDynamicBooleanValue=ruleDynamicBooleanValue
	{ $current=$iv_ruleDynamicBooleanValue.current; }
	EOF;

// Rule DynamicBooleanValue
ruleDynamicBooleanValue returns [EObject current=null]
@init {
	enterRule();
}
@after {
