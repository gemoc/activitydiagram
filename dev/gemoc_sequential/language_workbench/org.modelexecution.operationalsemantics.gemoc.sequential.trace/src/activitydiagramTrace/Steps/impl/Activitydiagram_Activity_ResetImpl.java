 ...
 * <ul>
 *   <li>{@link activitydiagramTrace.Steps.impl.Activitydiagram_Activity_ResetImpl#getMse <em>Mse</em>}</li>
 *   <li>{@link activitydiagramTrace.Steps.impl.Activitydiagram_Activity_ResetImpl#getParameters <em>Parameters</em>}</li>
 *   <li>{@link activitydiagramTrace.Steps.impl.Activitydiagram_Activity_ResetImpl#getResult <em>Result</em>}</li>
 *   <li>{@link activitydiagramTrace.Steps.impl.Activitydiagram_Activity_ResetImpl#getLogicalStep <em>Logical Step</em>}</li>
...
public class Activitydiagram_Activity_ResetImpl extends Activitydiagram_Activity_WriteTrace_AbstractSubStepImpl implements Activitydiagram_Activity_Reset {
		...
		if (mse != null && mse.eIsProxy()) {
			...
			if (mse != oldMse) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, StepsPackage.ACTIVITYDIAGRAM_ACTIVITY_RESET__MSE, oldMse, mse));
			}
		}
		return mse;
	}
	...
	public void setMse(MSE newMse) {
		...
		mse = newMse;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, StepsPackage.ACTIVITYDIAGRAM_ACTIVITY_RESET__MSE, oldMse, mse));
	}
	...
	public EList<Object> getParameters() {
		if (parameters == null) {
			parameters = new EDataTypeUniqueEList<Object>(Object.class, this, StepsPackage.ACTIVITYDIAGRAM_ACTIVITY_RESET__PARAMETERS);
		}
		return parameters;
	}
	...
	public EList<Object> getResult() {
		if (result == null) {
			result = new EDataTypeUniqueEList<Object>(Object.class, this, StepsPackage.ACTIVITYDIAGRAM_ACTIVITY_RESET__RESULT);
		}
		return result;
	}
	...
	public LogicalStep getLogicalStep() {
		if (logicalStep != null && logicalStep.eIsProxy()) {
			...
			if (logicalStep != oldLogicalStep) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, StepsPackage.ACTIVITYDIAGRAM_ACTIVITY_RESET__LOGICAL_STEP, oldLogicalStep, logicalStep));
			}
		}
		return logicalStep;
	}
	...
	public NotificationChain basicSetLogicalStep(LogicalStep newLogicalStep, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, StepsPackage.ACTIVITYDIAGRAM_ACTIVITY_RESET__LOGICAL_STEP, oldLogicalStep, newLogicalStep);
	...
	public void setLogicalStep(LogicalStep newLogicalStep) {
		if (newLogicalStep != logicalStep) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, StepsPackage.ACTIVITYDIAGRAM_ACTIVITY_RESET__LOGICAL_STEP, newLogicalStep, newLogicalStep));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case StepsPackage.ACTIVITYDIAGRAM_ACTIVITY_RESET__LOGICAL_STEP:
				if (logicalStep != null)
					msgs = ((InternalEObject)logicalStep).eInverseRemove(this, Engine_msePackage.LOGICAL_STEP__MSE_OCCURRENCES, LogicalStep.class, msgs);
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case StepsPackage.ACTIVITYDIAGRAM_ACTIVITY_RESET__MSE:
				if (resolve) return getMse();
				return basicGetMse();
			case StepsPackage.ACTIVITYDIAGRAM_ACTIVITY_RESET__PARAMETERS:
				return getParameters();
			case StepsPackage.ACTIVITYDIAGRAM_ACTIVITY_RESET__RESULT:
				return getResult();
			case StepsPackage.ACTIVITYDIAGRAM_ACTIVITY_RESET__LOGICAL_STEP:
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == MSEOccurrence.class) {
			switch (derivedFeatureID) {
				case StepsPackage.ACTIVITYDIAGRAM_ACTIVITY_RESET__MSE: return Engine_msePackage.MSE_OCCURRENCE__MSE;
				case StepsPackage.ACTIVITYDIAGRAM_ACTIVITY_RESET__PARAMETERS: return Engine_msePackage.MSE_OCCURRENCE__PARAMETERS;
				case StepsPackage.ACTIVITYDIAGRAM_ACTIVITY_RESET__RESULT: return Engine_msePackage.MSE_OCCURRENCE__RESULT;
				case StepsPackage.ACTIVITYDIAGRAM_ACTIVITY_RESET__LOGICAL_STEP: return Engine_msePackage.MSE_OCCURRENCE__LOGICAL_STEP;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == MSEOccurrence.class) {
			switch (baseFeatureID) {
				case Engine_msePackage.MSE_OCCURRENCE__MSE: return StepsPackage.ACTIVITYDIAGRAM_ACTIVITY_RESET__MSE;
				case Engine_msePackage.MSE_OCCURRENCE__PARAMETERS: return StepsPackage.ACTIVITYDIAGRAM_ACTIVITY_RESET__PARAMETERS;
				case Engine_msePackage.MSE_OCCURRENCE__RESULT: return StepsPackage.ACTIVITYDIAGRAM_ACTIVITY_RESET__RESULT;
				case Engine_msePackage.MSE_OCCURRENCE__LOGICAL_STEP: return StepsPackage.ACTIVITYDIAGRAM_ACTIVITY_RESET__LOGICAL_STEP;
				default: return -1;
			}
		}
		if (baseClass == Step.class) {
