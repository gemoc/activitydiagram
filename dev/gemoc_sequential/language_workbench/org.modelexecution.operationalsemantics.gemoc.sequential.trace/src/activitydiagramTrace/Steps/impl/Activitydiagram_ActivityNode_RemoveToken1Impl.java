 ...
 * <ul>
 *   <li>{@link activitydiagramTrace.Steps.impl.Activitydiagram_ActivityNode_RemoveToken1Impl#getPrecedingState <em>Preceding State</em>}</li>
 ...
 * @generated
 */
public class Activitydiagram_ActivityNode_RemoveToken1Impl extends Activitydiagram_ActivityNode_TakeOfferdTokens1_AbstractSubEventImpl implements Activitydiagram_ActivityNode_RemoveToken1 {
	/**
		...
		if (precedingState != null && precedingState.eIsProxy()) {
			...
			if (precedingState != oldPrecedingState) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, StepsPackage.ACTIVITYDIAGRAM_ACTIVITY_NODE_REMOVE_TOKEN1__PRECEDING_STATE, oldPrecedingState, precedingState));
			}
		}
	...
	public NotificationChain basicSetPrecedingState(State newPrecedingState, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, StepsPackage.ACTIVITYDIAGRAM_ACTIVITY_NODE_REMOVE_TOKEN1__PRECEDING_STATE, oldPrecedingState, newPrecedingState);
	...
	public void setPrecedingState(State newPrecedingState) {
		if (newPrecedingState != precedingState) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, StepsPackage.ACTIVITYDIAGRAM_ACTIVITY_NODE_REMOVE_TOKEN1__PRECEDING_STATE, newPrecedingState, newPrecedingState));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case StepsPackage.ACTIVITYDIAGRAM_ACTIVITY_NODE_REMOVE_TOKEN1__PRECEDING_STATE:
				if (precedingState != null)
					msgs = ((InternalEObject)precedingState).eInverseRemove(this, ActivitydiagramTracePackage.STATE__FOLLOWING_STEP, State.class, msgs);
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == Activitydiagram_ActivityNode_AddTokens1_AbstractSubEvent.class) {
		...
		if (baseClass == SmallStep.class) {
			switch (derivedFeatureID) {
				case StepsPackage.ACTIVITYDIAGRAM_ACTIVITY_NODE_REMOVE_TOKEN1__PRECEDING_STATE: return StepsPackage.SMALL_STEP__PRECEDING_STATE;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		...
		if (baseClass == SmallStep.class) {
			switch (baseFeatureID) {
				case StepsPackage.SMALL_STEP__PRECEDING_STATE: return StepsPackage.ACTIVITYDIAGRAM_ACTIVITY_NODE_REMOVE_TOKEN1__PRECEDING_STATE;
				default: return -1;
			}
		}
