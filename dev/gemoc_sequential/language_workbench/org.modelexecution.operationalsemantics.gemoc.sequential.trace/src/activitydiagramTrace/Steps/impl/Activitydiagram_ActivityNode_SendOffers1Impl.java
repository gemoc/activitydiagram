	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == MSEOccurrence.class) {
			switch (derivedFeatureID) {
				case StepsPackage.ACTIVITYDIAGRAM_ACTIVITY_NODE_SEND_OFFERS1__MSE: return Engine_msePackage.MSE_OCCURRENCE__MSE;
				case StepsPackage.ACTIVITYDIAGRAM_ACTIVITY_NODE_SEND_OFFERS1__PARAMETERS: return Engine_msePackage.MSE_OCCURRENCE__PARAMETERS;
				case StepsPackage.ACTIVITYDIAGRAM_ACTIVITY_NODE_SEND_OFFERS1__RESULT: return Engine_msePackage.MSE_OCCURRENCE__RESULT;
				case StepsPackage.ACTIVITYDIAGRAM_ACTIVITY_NODE_SEND_OFFERS1__LOGICAL_STEP: return Engine_msePackage.MSE_OCCURRENCE__LOGICAL_STEP;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == MSEOccurrence.class) {
			switch (baseFeatureID) {
				case Engine_msePackage.MSE_OCCURRENCE__MSE: return StepsPackage.ACTIVITYDIAGRAM_ACTIVITY_NODE_SEND_OFFERS1__MSE;
				case Engine_msePackage.MSE_OCCURRENCE__PARAMETERS: return StepsPackage.ACTIVITYDIAGRAM_ACTIVITY_NODE_SEND_OFFERS1__PARAMETERS;
				case Engine_msePackage.MSE_OCCURRENCE__RESULT: return StepsPackage.ACTIVITYDIAGRAM_ACTIVITY_NODE_SEND_OFFERS1__RESULT;
				case Engine_msePackage.MSE_OCCURRENCE__LOGICAL_STEP: return StepsPackage.ACTIVITYDIAGRAM_ACTIVITY_NODE_SEND_OFFERS1__LOGICAL_STEP;
				default: return -1;
			}
		}
		if (baseClass == Step.class) {
