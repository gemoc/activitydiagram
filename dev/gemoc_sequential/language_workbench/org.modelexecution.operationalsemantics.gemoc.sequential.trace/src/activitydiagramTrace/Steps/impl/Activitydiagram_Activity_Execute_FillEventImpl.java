...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Activitydiagram Activity Execute Fill Event</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link activitydiagramTrace.Steps.impl.Activitydiagram_Activity_Execute_FillEventImpl#getPrecedingState <em>Preceding State</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class Activitydiagram_Activity_Execute_FillEventImpl extends Activitydiagram_Activity_Execute_AbstractSubEventImpl implements Activitydiagram_Activity_Execute_FillEvent {
	/**
	 ...
	 * @generated
	 */
	protected Activitydiagram_Activity_Execute_FillEventImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return StepsPackage.Literals.ACTIVITYDIAGRAM_ACTIVITY_EXECUTE_FILL_EVENT;
	}
		...
		if (precedingState != null && precedingState.eIsProxy()) {
			...
			if (precedingState != oldPrecedingState) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, StepsPackage.ACTIVITYDIAGRAM_ACTIVITY_EXECUTE_FILL_EVENT__PRECEDING_STATE, oldPrecedingState, precedingState));
			}
		}
	...
	public NotificationChain basicSetPrecedingState(State newPrecedingState, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, StepsPackage.ACTIVITYDIAGRAM_ACTIVITY_EXECUTE_FILL_EVENT__PRECEDING_STATE, oldPrecedingState, newPrecedingState);
	...
	public void setPrecedingState(State newPrecedingState) {
		if (newPrecedingState != precedingState) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, StepsPackage.ACTIVITYDIAGRAM_ACTIVITY_EXECUTE_FILL_EVENT__PRECEDING_STATE, newPrecedingState, newPrecedingState));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case StepsPackage.ACTIVITYDIAGRAM_ACTIVITY_EXECUTE_FILL_EVENT__PRECEDING_STATE:
				if (precedingState != null)
					msgs = ((InternalEObject)precedingState).eInverseRemove(this, ActivitydiagramTracePackage.STATE__FOLLOWING_STEP, State.class, msgs);
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == SmallStep.class) {
			switch (derivedFeatureID) {
				case StepsPackage.ACTIVITYDIAGRAM_ACTIVITY_EXECUTE_FILL_EVENT__PRECEDING_STATE: return StepsPackage.SMALL_STEP__PRECEDING_STATE;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == SmallStep.class) {
			switch (baseFeatureID) {
				case StepsPackage.SMALL_STEP__PRECEDING_STATE: return StepsPackage.ACTIVITYDIAGRAM_ACTIVITY_EXECUTE_FILL_EVENT__PRECEDING_STATE;
				default: return -1;
			}
		}
...
} //Activitydiagram_Activity_Execute_FillEventImpl
