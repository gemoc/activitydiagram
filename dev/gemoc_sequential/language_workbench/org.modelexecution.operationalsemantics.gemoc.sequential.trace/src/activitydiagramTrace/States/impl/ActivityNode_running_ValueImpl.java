...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Activity Node running Value</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 ...
 * @generated
 */
public class ActivityNode_running_ValueImpl extends MinimalEObjectImpl.Container implements ActivityNode_running_Value {
	/**
	 ...
	 * @generated
	 */
	protected ActivityNode_running_ValueImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return StatesPackage.Literals.ACTIVITY_NODE_RUNNING_VALUE;
	}
	...
	public NotificationChain basicSetParent(TracedActivityNode newParent, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject)newParent, StatesPackage.ACTIVITY_NODE_RUNNING_VALUE__PARENT, msgs);
		return msgs;
	}
	...
	public void setParent(TracedActivityNode newParent) {
		if (newParent != eInternalContainer() || (eContainerFeatureID() != StatesPackage.ACTIVITY_NODE_RUNNING_VALUE__PARENT && newParent != null)) {
			...
			if (newParent != null)
				msgs = ((InternalEObject)newParent).eInverseAdd(this, ActivitydiagramPackage.TRACED_ACTIVITY_NODE__RUNNING_SEQUENCE, TracedActivityNode.class, msgs);
	...
	public EList<State> getStates() {
		if (states == null) {
			states = new EObjectWithInverseResolvingEList.ManyInverse<State>(State.class, this, StatesPackage.ACTIVITY_NODE_RUNNING_VALUE__STATES, StatesPackage.STATE__ACTIVITY_NODE_RUNNING_VALUES);
		}
		return states;
	}
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		switch (eContainerFeatureID()) {
			case StatesPackage.ACTIVITY_NODE_RUNNING_VALUE__PARENT:
				return eInternalContainer().eInverseRemove(this, ActivitydiagramPackage.TRACED_ACTIVITY_NODE__RUNNING_SEQUENCE, TracedActivityNode.class, msgs);
		}
...
} //ActivityNode_running_ValueImpl
