 ...
 * <ul>
 *   <li>{@link activitydiagramTrace.Traced.activitydiagram.impl.TracedActivityNodeImpl#getOutgoing <em>Outgoing</em>}</li>
 *   <li>{@link activitydiagramTrace.Traced.activitydiagram.impl.TracedActivityNodeImpl#getIncoming <em>Incoming</em>}</li>
 *   <li>{@link activitydiagramTrace.Traced.activitydiagram.impl.TracedActivityNodeImpl#getActivity <em>Activity</em>}</li>
 *   <li>{@link activitydiagramTrace.Traced.activitydiagram.impl.TracedActivityNodeImpl#getHeldTokens <em>Held Tokens</em>}</li>
 *   <li>{@link activitydiagramTrace.Traced.activitydiagram.impl.TracedActivityNodeImpl#getHeldTokensTrace <em>Held Tokens Trace</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class TracedActivityNodeImpl extends TracedNamedElementImpl implements TracedActivityNode {
	...
	/**
	 * The cached value of the '{@link #getHeldTokensTrace() <em>Held Tokens Trace</em>}' containment reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getHeldTokensTrace()
	 * @generated
	 * @ordered
	 */
	protected EList<ActivityNode_heldTokens_Value> heldTokensTrace;
	 ...
	 * @generated
	 */
	public EList<ActivityNode_heldTokens_Value> getHeldTokensTrace() {
		if (heldTokensTrace == null) {
			heldTokensTrace = new EObjectContainmentWithInverseEList<ActivityNode_heldTokens_Value>(ActivityNode_heldTokens_Value.class, this, ActivitydiagramPackage.TRACED_ACTIVITY_NODE__HELD_TOKENS_TRACE, ValuesPackage.ACTIVITY_NODE_HELD_TOKENS_VALUE__PARENT);
		}
		return heldTokensTrace;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ActivitydiagramPackage.TRACED_ACTIVITY_NODE__HELD_TOKENS_TRACE:
				return ((InternalEList<InternalEObject>)(InternalEList<?>)getHeldTokensTrace()).basicAdd(otherEnd, msgs);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ActivitydiagramPackage.TRACED_ACTIVITY_NODE__HELD_TOKENS_TRACE:
				return ((InternalEList<?>)getHeldTokensTrace()).basicRemove(otherEnd, msgs);
		}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case ActivitydiagramPackage.TRACED_ACTIVITY_NODE__HELD_TOKENS:
				...
				return;
			case ActivitydiagramPackage.TRACED_ACTIVITY_NODE__HELD_TOKENS_TRACE:
				getHeldTokensTrace().clear();
				getHeldTokensTrace().addAll((Collection<? extends ActivityNode_heldTokens_Value>)newValue);
				return;
		}
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
			...
			case ActivitydiagramPackage.TRACED_ACTIVITY_NODE__HELD_TOKENS_TRACE:
				return heldTokensTrace != null && !heldTokensTrace.isEmpty();
		}
