 ...
 * <ul>
 *   <li>{@link activitydiagramTrace.Traced.activitydiagram.impl.TracedActivityImpl#getNodes <em>Nodes</em>}</li>
 *   <li>{@link activitydiagramTrace.Traced.activitydiagram.impl.TracedActivityImpl#getEdges <em>Edges</em>}</li>
 *   <li>{@link activitydiagramTrace.Traced.activitydiagram.impl.TracedActivityImpl#getLocals <em>Locals</em>}</li>
 *   <li>{@link activitydiagramTrace.Traced.activitydiagram.impl.TracedActivityImpl#getInputs <em>Inputs</em>}</li>
 *   <li>{@link activitydiagramTrace.Traced.activitydiagram.impl.TracedActivityImpl#getTrace <em>Trace</em>}</li>
 *   <li>{@link activitydiagramTrace.Traced.activitydiagram.impl.TracedActivityImpl#getOriginalObject <em>Original Object</em>}</li>
 *   <li>{@link activitydiagramTrace.Traced.activitydiagram.impl.TracedActivityImpl#getTraceTrace <em>Trace Trace</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TracedActivityImpl extends TracedNamedElementImpl implements TracedActivity {
	...
	/**
	 * The cached value of the '{@link #getTraceTrace() <em>Trace Trace</em>}' containment reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getTraceTrace()
	 * @generated
	 * @ordered
	 */
	protected EList<Activity_trace_Value> traceTrace;
	 ...
	 * @generated
	 */
	public EList<Activity_trace_Value> getTraceTrace() {
		if (traceTrace == null) {
			traceTrace = new EObjectContainmentWithInverseEList<Activity_trace_Value>(Activity_trace_Value.class, this, ActivitydiagramPackage.TRACED_ACTIVITY__TRACE_TRACE, ValuesPackage.ACTIVITY_TRACE_VALUE__PARENT);
		}
		return traceTrace;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ActivitydiagramPackage.TRACED_ACTIVITY__TRACE_TRACE:
				return ((InternalEList<InternalEObject>)(InternalEList<?>)getTraceTrace()).basicAdd(otherEnd, msgs);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ActivitydiagramPackage.TRACED_ACTIVITY__TRACE_TRACE:
				return ((InternalEList<?>)getTraceTrace()).basicRemove(otherEnd, msgs);
		}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case ActivitydiagramPackage.TRACED_ACTIVITY__TRACE_TRACE:
				getTraceTrace().clear();
				getTraceTrace().addAll((Collection<? extends Activity_trace_Value>)newValue);
				return;
		}
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
			...
			case ActivitydiagramPackage.TRACED_ACTIVITY__TRACE_TRACE:
				return traceTrace != null && !traceTrace.isEmpty();
		}
