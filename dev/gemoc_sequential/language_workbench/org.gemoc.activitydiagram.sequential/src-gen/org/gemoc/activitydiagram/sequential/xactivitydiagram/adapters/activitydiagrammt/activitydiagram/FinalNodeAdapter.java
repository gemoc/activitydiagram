...
public class FinalNodeAdapter extends EObjectAdapter<FinalNode> implements activitydiagram.FinalNode {
  ...
  public EClass eClass() {
    return activitydiagram.ActivitydiagramPackage.eINSTANCE.getFinalNode();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case activitydiagram.ActivitydiagramPackage.FINAL_NODE__NAME:
    		return getName();
    	case activitydiagram.ActivitydiagramPackage.FINAL_NODE__OUTGOING:
    		return getOutgoing();
    	case activitydiagram.ActivitydiagramPackage.FINAL_NODE__INCOMING:
    		return getIncoming();
    	case activitydiagram.ActivitydiagramPackage.FINAL_NODE__ACTIVITY:
    		return getActivity();
    	case activitydiagram.ActivitydiagramPackage.FINAL_NODE__RUNNING:
