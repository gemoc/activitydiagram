...
public class ExecutableNodeAdapter extends EObjectAdapter<ExecutableNode> implements activitydiagram.ExecutableNode {
  ...
  public EClass eClass() {
    return activitydiagram.ActivitydiagramPackage.eINSTANCE.getExecutableNode();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case activitydiagram.ActivitydiagramPackage.EXECUTABLE_NODE__NAME:
    		return getName();
    	case activitydiagram.ActivitydiagramPackage.EXECUTABLE_NODE__OUTGOING:
    		return getOutgoing();
    	case activitydiagram.ActivitydiagramPackage.EXECUTABLE_NODE__INCOMING:
    		return getIncoming();
    	case activitydiagram.ActivitydiagramPackage.EXECUTABLE_NODE__ACTIVITY:
    		return getActivity();
    	case activitydiagram.ActivitydiagramPackage.EXECUTABLE_NODE__RUNNING:
