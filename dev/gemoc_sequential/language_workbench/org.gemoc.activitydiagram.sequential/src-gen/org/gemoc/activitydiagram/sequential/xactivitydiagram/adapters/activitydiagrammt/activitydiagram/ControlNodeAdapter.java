...
public class ControlNodeAdapter extends EObjectAdapter<ControlNode> implements activitydiagram.ControlNode {
  ...
  public EClass eClass() {
    return activitydiagram.ActivitydiagramPackage.eINSTANCE.getControlNode();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case activitydiagram.ActivitydiagramPackage.CONTROL_NODE__NAME:
    		return getName();
    	case activitydiagram.ActivitydiagramPackage.CONTROL_NODE__OUTGOING:
    		return getOutgoing();
    	case activitydiagram.ActivitydiagramPackage.CONTROL_NODE__INCOMING:
    		return getIncoming();
    	case activitydiagram.ActivitydiagramPackage.CONTROL_NODE__ACTIVITY:
    		return getActivity();
    	case activitydiagram.ActivitydiagramPackage.CONTROL_NODE__RUNNING:
