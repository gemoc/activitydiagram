...
public class ActivityNodeAdapter extends EObjectAdapter<ActivityNode> implements activitydiagram.ActivityNode {
  ...
  public EClass eClass() {
    return activitydiagram.ActivitydiagramPackage.eINSTANCE.getActivityNode();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case activitydiagram.ActivitydiagramPackage.ACTIVITY_NODE__NAME:
    		return getName();
    	case activitydiagram.ActivitydiagramPackage.ACTIVITY_NODE__OUTGOING:
    		return getOutgoing();
    	case activitydiagram.ActivitydiagramPackage.ACTIVITY_NODE__INCOMING:
    		return getIncoming();
    	case activitydiagram.ActivitydiagramPackage.ACTIVITY_NODE__ACTIVITY:
    		return getActivity();
    	case activitydiagram.ActivitydiagramPackage.ACTIVITY_NODE__RUNNING:
