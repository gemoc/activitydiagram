...
public class ActivityFinalNodeAdapter extends EObjectAdapter<ActivityFinalNode> implements activitydiagram.ActivityFinalNode {
  ...
  public EClass eClass() {
    return activitydiagram.ActivitydiagramPackage.eINSTANCE.getActivityFinalNode();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case activitydiagram.ActivitydiagramPackage.ACTIVITY_FINAL_NODE__NAME:
    		return getName();
    	case activitydiagram.ActivitydiagramPackage.ACTIVITY_FINAL_NODE__OUTGOING:
    		return getOutgoing();
    	case activitydiagram.ActivitydiagramPackage.ACTIVITY_FINAL_NODE__INCOMING:
    		return getIncoming();
    	case activitydiagram.ActivitydiagramPackage.ACTIVITY_FINAL_NODE__ACTIVITY:
    		return getActivity();
    	case activitydiagram.ActivitydiagramPackage.ACTIVITY_FINAL_NODE__RUNNING:
