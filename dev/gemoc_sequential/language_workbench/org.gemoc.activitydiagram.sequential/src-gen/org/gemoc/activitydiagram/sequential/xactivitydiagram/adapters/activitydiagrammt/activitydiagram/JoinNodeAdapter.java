...
public class JoinNodeAdapter extends EObjectAdapter<JoinNode> implements activitydiagram.JoinNode {
  ...
  public EClass eClass() {
    return activitydiagram.ActivitydiagramPackage.eINSTANCE.getJoinNode();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case activitydiagram.ActivitydiagramPackage.JOIN_NODE__NAME:
    		return getName();
    	case activitydiagram.ActivitydiagramPackage.JOIN_NODE__OUTGOING:
    		return getOutgoing();
    	case activitydiagram.ActivitydiagramPackage.JOIN_NODE__INCOMING:
    		return getIncoming();
    	case activitydiagram.ActivitydiagramPackage.JOIN_NODE__ACTIVITY:
    		return getActivity();
    	case activitydiagram.ActivitydiagramPackage.JOIN_NODE__RUNNING:
