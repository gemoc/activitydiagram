...
public class StaticIntegerValueAdapter extends EObjectAdapter<StaticIntegerValue> implements org.gemoc.activitydiagram.sequential.xactivitydiagrammt.activitydiagram.StaticIntegerValue {
  private XActivityDiagramMTAdaptersFactory adaptersFactory;
  
  public StaticIntegerValueAdapter() {
  ...
  public EClass eClass() {
    return org.gemoc.activitydiagram.sequential.xactivitydiagrammt.activitydiagram.ActivitydiagramPackage.eINSTANCE.getStaticIntegerValue();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case org.gemoc.activitydiagram.sequential.xactivitydiagrammt.activitydiagram.ActivitydiagramPackage.STATIC_INTEGER_VALUE__VALUE:
