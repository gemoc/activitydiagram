...
public class ForkNodeAdapter extends EObjectAdapter<ForkNode> implements activitydiagram.ForkNode {
  ...
  public EClass eClass() {
    return activitydiagram.ActivitydiagramPackage.eINSTANCE.getForkNode();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case activitydiagram.ActivitydiagramPackage.FORK_NODE__NAME:
    		return getName();
    	case activitydiagram.ActivitydiagramPackage.FORK_NODE__OUTGOING:
    		return getOutgoing();
    	case activitydiagram.ActivitydiagramPackage.FORK_NODE__INCOMING:
    		return getIncoming();
    	case activitydiagram.ActivitydiagramPackage.FORK_NODE__ACTIVITY:
    		return getActivity();
    	case activitydiagram.ActivitydiagramPackage.FORK_NODE__RUNNING:
