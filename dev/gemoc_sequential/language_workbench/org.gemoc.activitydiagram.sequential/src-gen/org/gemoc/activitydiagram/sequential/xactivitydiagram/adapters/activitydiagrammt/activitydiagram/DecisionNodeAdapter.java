...
public class DecisionNodeAdapter extends EObjectAdapter<DecisionNode> implements activitydiagram.DecisionNode {
  ...
  public EClass eClass() {
    return activitydiagram.ActivitydiagramPackage.eINSTANCE.getDecisionNode();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case activitydiagram.ActivitydiagramPackage.DECISION_NODE__NAME:
    		return getName();
    	case activitydiagram.ActivitydiagramPackage.DECISION_NODE__OUTGOING:
    		return getOutgoing();
    	case activitydiagram.ActivitydiagramPackage.DECISION_NODE__INCOMING:
    		return getIncoming();
    	case activitydiagram.ActivitydiagramPackage.DECISION_NODE__ACTIVITY:
    		return getActivity();
    	case activitydiagram.ActivitydiagramPackage.DECISION_NODE__RUNNING:
