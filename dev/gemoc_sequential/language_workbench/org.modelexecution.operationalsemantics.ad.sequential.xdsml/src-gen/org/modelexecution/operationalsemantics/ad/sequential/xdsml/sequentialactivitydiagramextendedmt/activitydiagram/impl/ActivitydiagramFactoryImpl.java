...
public class ActivitydiagramFactoryImpl extends EFactoryImpl implements ActivitydiagramFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			...
			case ActivitydiagramPackage.XTEND_RECORDING_COMMAND: return createXtendRecordingCommand();
			case ActivitydiagramPackage.LOAD_INPUT_VALUES_RECORDING_COMMAND: return createLoadInputValuesRecordingCommand();
			case ActivitydiagramPackage.NULL: return createnull();
			default:
	 ...
	 * @generated
	 */
	public LoadInputValuesRecordingCommand createLoadInputValuesRecordingCommand() {
		throw new UnsupportedOperationException("Cannot invoke element creation on a model type");
	}
