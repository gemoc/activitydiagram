...
public class InputValueAdapter extends EObjectAdapter<InputValue> implements org.modelexecution.operationalsemantics.ad.sequential.xdsml.sequentialactivitydiagrammt.activitydiagram.InputValue {
  ...
  public void setValue(final Value o) {
    if (o != null)
    	adaptee.setValue(((org.modelexecution.operationalsemantics.ad.sequential.xdsml.sequentialactivitydiagramextended.adapters.sequentialactivitydiagrammt.ValueAdapter) o).getAdaptee()) ;
  ...
  public void setVariable(final Variable o) {
    if (o != null)
    	adaptee.setVariable(((org.modelexecution.operationalsemantics.ad.sequential.xdsml.sequentialactivitydiagramextended.adapters.sequentialactivitydiagrammt.VariableAdapter) o).getAdaptee()) ;
