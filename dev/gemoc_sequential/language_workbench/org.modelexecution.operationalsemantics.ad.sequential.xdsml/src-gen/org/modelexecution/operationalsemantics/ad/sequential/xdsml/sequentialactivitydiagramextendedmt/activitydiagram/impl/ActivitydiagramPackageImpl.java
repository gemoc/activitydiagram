/**
 */
package org.modelexecution.operationalsemantics.ad.sequential.xdsml.sequentialactivitydiagramextendedmt.activitydiagram.impl;
...
import org.modelexecution.operationalsemantics.ad.sequential.xdsml.sequentialactivitydiagramextendedmt.activitydiagram.Action;
...
import org.modelexecution.operationalsemantics.ad.sequential.xdsml.sequentialactivitydiagramextendedmt.activitydiagram.BooleanExpression;
...
import org.modelexecution.operationalsemantics.ad.sequential.xdsml.sequentialactivitydiagramextendedmt.activitydiagram.ControlNode;
...
import org.modelexecution.operationalsemantics.ad.sequential.xdsml.sequentialactivitydiagramextendedmt.activitydiagram.ExecutableNode;
import org.modelexecution.operationalsemantics.ad.sequential.xdsml.sequentialactivitydiagramextendedmt.activitydiagram.Expression;
import org.modelexecution.operationalsemantics.ad.sequential.xdsml.sequentialactivitydiagramextendedmt.activitydiagram.FinalNode;
...
import org.modelexecution.operationalsemantics.ad.sequential.xdsml.sequentialactivitydiagramextendedmt.activitydiagram.IntegerExpression;
...
import org.modelexecution.operationalsemantics.ad.sequential.xdsml.sequentialactivitydiagramextendedmt.activitydiagram.LoadInputValuesRecordingCommand;
...
import org.modelexecution.operationalsemantics.ad.sequential.xdsml.sequentialactivitydiagramextendedmt.activitydiagram.NamedElement;
...
import org.modelexecution.operationalsemantics.ad.sequential.xdsml.sequentialactivitydiagramextendedmt.activitydiagram.null;
...
public class ActivitydiagramPackageImpl extends EPackageImpl implements ActivitydiagramPackage {
	 ...
	 * @generated
	 */
	private EClass xtendRecordingCommandEClass = null;
	 ...
	 * @generated
	 */
	private EClass loadInputValuesRecordingCommandEClass = null;
	 ...
	 * @see org.modelexecution.operationalsemantics.ad.sequential.xdsml.sequentialactivitydiagramextendedmt.activitydiagram.ActivitydiagramPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	 ...
	 * @generated
	 */
	public EClass getXtendRecordingCommand() {
		return xtendRecordingCommandEClass;
	}
	 ...
	 * @generated
	 */
	public EClass getLoadInputValuesRecordingCommand() {
		return loadInputValuesRecordingCommandEClass;
	}
	...
	public void createPackageContents() {
		...
		xtendRecordingCommandEClass = createEClass(XTEND_RECORDING_COMMAND);

		loadInputValuesRecordingCommandEClass = createEClass(LOAD_INPUT_VALUES_RECORDING_COMMAND);
	...
	public void initializePackageContents() {
		...
		xtendRecordingCommandEClass.getESuperTypes().add(this.getnull());
		loadInputValuesRecordingCommandEClass.getESuperTypes().add(this.getXtendRecordingCommand());
		...
		initEClass(xtendRecordingCommandEClass, XtendRecordingCommand.class, "XtendRecordingCommand", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

		initEClass(loadInputValuesRecordingCommandEClass, LoadInputValuesRecordingCommand.class, "LoadInputValuesRecordingCommand", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

		addEOperation(loadInputValuesRecordingCommandEClass, null, "doExecute", 0, 1, IS_UNIQUE, IS_ORDERED);
	...
	protected void createAspectAnnotations() {
		...
		addAnnotation
		  (loadInputValuesRecordingCommandEClass, 
		   source, 
		   new String[] {
		   });	
		addAnnotation
		  (loadInputValuesRecordingCommandEClass.getEOperations().get(0), 
		   source, 
		   new String[] {
		   });
	}
