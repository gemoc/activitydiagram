...
public class OfferAspect {
  public static boolean hasTokens(final Offer _self) {
	final org.gemoc.activitydiagram.sequential.xactivitydiagram.aspects.OfferAspectOfferAspectProperties _self_ = org.gemoc.activitydiagram.sequential.xactivitydiagram.aspects.OfferAspectOfferAspectContext
			.getSelf(_self);
	Object result = null;
	result = _privk3_hasTokens(_self_, _self);
	;
  ...
  public static void removeWithdrawnTokens(final Offer _self) {
	final org.gemoc.activitydiagram.sequential.xactivitydiagram.aspects.OfferAspectOfferAspectProperties _self_ = org.gemoc.activitydiagram.sequential.xactivitydiagram.aspects.OfferAspectOfferAspectContext
			.getSelf(_self);
	_privk3_removeWithdrawnTokens(_self_, _self);
	;
}
  ...
  protected static boolean _privk3_hasTokens(final OfferAspectOfferAspectProperties _self_, final Offer _self) {
    ...
    int _size = OfferAspect.offeredTokens(_self).size();
    return (_size > 0);
  }
  ...
  protected static void _privk3_removeWithdrawnTokens(final OfferAspectOfferAspectProperties _self_, final Offer _self) {
    ...
    OfferAspect.offeredTokens(_self).forEach(_function);
    OfferAspect.offeredTokens(_self).removeAll(tokensToBeRemoved);
  }
