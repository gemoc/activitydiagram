...
public class InputAspect {
  @Containment
  public static UniqueEList<InputValue> inputValues(final Input _self) {
    ...
    return (org.eclipse.emf.common.util.UniqueEList<org.gemoc.activitydiagram.sequential.xactivitydiagram.activitydiagram.InputValue>)result;
  }
  
  @Containment
  public static void inputValues(final Input _self, final UniqueEList<InputValue> inputValues) {
    final org.gemoc.activitydiagram.sequential.xactivitydiagram.aspects.InputAspectInputAspectProperties _self_ = org.gemoc.activitydiagram.sequential.xactivitydiagram.aspects.InputAspectInputAspectContext.getSelf(_self);
    _privk3_inputValues(_self_, _self,inputValues);;
  }
  
  protected static UniqueEList<InputValue> _privk3_inputValues(final InputAspectInputAspectProperties _self_, final Input _self) {
    try {
  ...
  protected static void _privk3_inputValues(final InputAspectInputAspectProperties _self_, final Input _self, final UniqueEList<InputValue> inputValues) {
