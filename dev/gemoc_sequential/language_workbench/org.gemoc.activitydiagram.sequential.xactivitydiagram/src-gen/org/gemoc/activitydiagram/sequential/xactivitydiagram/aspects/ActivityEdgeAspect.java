...
public class ActivityEdgeAspect extends NamedElementAspect {
	...
	@Containment
	public static UniqueEList<Offer> offers(final ActivityEdge _self) {
		final org.gemoc.activitydiagram.sequential.xactivitydiagram.aspects.ActivityEdgeAspectActivityEdgeAspectProperties _self_ = org.gemoc.activitydiagram.sequential.xactivitydiagram.aspects.ActivityEdgeAspectActivityEdgeAspectContext
				.getSelf(_self);
		Object result = null;
		result = _privk3_offers(_self_, _self);
		;
		return (org.eclipse.emf.common.util.UniqueEList<org.gemoc.activitydiagram.sequential.xactivitydiagram.activitydiagram.Offer>) result;
	}

	@Containment
	public static void offers(final ActivityEdge _self, final UniqueEList<Offer> offers) {
		final org.gemoc.activitydiagram.sequential.xactivitydiagram.aspects.ActivityEdgeAspectActivityEdgeAspectProperties _self_ = org.gemoc.activitydiagram.sequential.xactivitydiagram.aspects.ActivityEdgeAspectActivityEdgeAspectContext
				.getSelf(_self);
	...
	protected static void _privk3_sendOffer1(final ActivityEdgeAspectActivityEdgeAspectProperties _self_,
			final ActivityEdge _self, final EList<Token> tokens) {
		final Offer offer = ActivitydiagramFactory.eINSTANCE.createOffer();
		UniqueEList<Offer> _offers = ActivityEdgeAspect.offers(_self);
		_offers.add(offer);
	...
	protected static EList<Token> _privk3_takeOfferedTokens1(
			final ActivityEdgeAspectActivityEdgeAspectProperties _self_, final ActivityEdge _self) {
		...
		UniqueEList<Offer> _offers_1 = ActivityEdgeAspect.offers(_self);
		_offers_1.clear();
		return tokens;
	}

	protected static boolean _privk3_hasOffer1(final ActivityEdgeAspectActivityEdgeAspectProperties _self_,
			final ActivityEdge _self) {
		UniqueEList<Offer> _offers = ActivityEdgeAspect.offers(_self);
	...
	protected static EList<Offer> _privk3_offers(final ActivityEdgeAspectActivityEdgeAspectProperties _self_,
			final ActivityEdge _self) {
		try {
			for (java.lang.reflect.Method m : _self.getClass().getMethods()) {
				if (m.getName().equals("getOffers") && m.getParameterTypes().length == 0) {
	...
	protected static void _privk3_offers(final ActivityEdgeAspectActivityEdgeAspectProperties _self_,
			final ActivityEdge _self, final UniqueEList<Offer> offers) {
		_self_.offers = offers;
		try {
			for (java.lang.reflect.Method m : _self.getClass().getMethods()) {
				if (m.getName().equals("setOffers") && m.getParameterTypes().length == 1) {
