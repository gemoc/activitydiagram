 ...
 * </p>
 * <ul>
 *   <li>{@link activitydiagramTrace.States.impl.ActivityNode_heldTokens_ValueImpl#getStatesNoOpposite <em>States No Opposite</em>}</li>
...
public class ActivityNode_heldTokens_ValueImpl extends MinimalEObjectImpl.Container implements ActivityNode_heldTokens_Value {
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case StatesPackage.ACTIVITY_NODE_HELD_TOKENS_VALUE__STATES_NO_OPPOSITE:
