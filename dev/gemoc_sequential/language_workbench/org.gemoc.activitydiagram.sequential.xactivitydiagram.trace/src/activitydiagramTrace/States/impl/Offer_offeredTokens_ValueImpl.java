 ...
 * </p>
 * <ul>
 *   <li>{@link activitydiagramTrace.States.impl.Offer_offeredTokens_ValueImpl#getStatesNoOpposite <em>States No Opposite</em>}</li>
...
public class Offer_offeredTokens_ValueImpl extends MinimalEObjectImpl.Container implements Offer_offeredTokens_Value {
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case StatesPackage.OFFER_OFFERED_TOKENS_VALUE__STATES_NO_OPPOSITE:
