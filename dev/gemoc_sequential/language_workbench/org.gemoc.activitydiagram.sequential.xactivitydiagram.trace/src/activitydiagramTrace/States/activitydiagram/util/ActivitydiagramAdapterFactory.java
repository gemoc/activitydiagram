...
public class ActivitydiagramAdapterFactory extends AdapterFactoryImpl {
	...
	protected ActivitydiagramSwitch<Adapter> modelSwitch =
		new ActivitydiagramSwitch<Adapter>() {
			...
			@Override
			public Adapter caseTracedDynamicBooleanValue(TracedDynamicBooleanValue object) {
				return createTracedDynamicBooleanValueAdapter();
			}
			@Override
			public Adapter caseTracedDynamicIntegerValue(TracedDynamicIntegerValue object) {
				return createTracedDynamicIntegerValueAdapter();
			}
			@Override
			...
			@Override
			public Adapter caseTracedStaticBooleanValue(TracedStaticBooleanValue object) {
				return createTracedStaticBooleanValueAdapter();
			}
			@Override
			public Adapter caseTracedStaticIntegerValue(TracedStaticIntegerValue object) {
				return createTracedStaticIntegerValueAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link activitydiagramTrace.States.activitydiagram.TracedDynamicBooleanValue <em>Traced Dynamic Boolean Value</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createTracedDynamicBooleanValueAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link activitydiagramTrace.States.activitydiagram.TracedDynamicIntegerValue <em>Traced Dynamic Integer Value</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createTracedDynamicIntegerValueAdapter() {
		return null;
	}
	...
	/**
	 * Creates a new adapter for an object of class '{@link activitydiagramTrace.States.activitydiagram.TracedStaticBooleanValue <em>Traced Static Boolean Value</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createTracedStaticBooleanValueAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link activitydiagramTrace.States.activitydiagram.TracedStaticIntegerValue <em>Traced Static Integer Value</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createTracedStaticIntegerValueAdapter() {
		return null;
	}
