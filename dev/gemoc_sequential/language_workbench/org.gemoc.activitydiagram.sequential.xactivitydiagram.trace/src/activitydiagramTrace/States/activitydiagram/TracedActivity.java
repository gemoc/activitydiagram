 ...
 * </p>
 * <ul>
 *   <li>{@link activitydiagramTrace.States.activitydiagram.TracedActivity#getActivity_trace_Dimension <em>Activity trace Dimension</em>}</li>
...
public interface TracedActivity extends TracedNamedElement {
	/**
	 * Returns the value of the '<em><b>Activity trace Dimension</b></em>' containment reference.
	 * <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Activity trace Dimension</em>' containment reference isn't clear,
	 * there really should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Activity trace Dimension</em>' containment reference.
	 * @see #setActivity_trace_Dimension(Activity_trace_Dimension)
	 * @see activitydiagramTrace.States.activitydiagram.ActivitydiagramPackage#getTracedActivity_Activity_trace_Dimension()
	 * @model containment="true"
	 * @generated
	 */
	Activity_trace_Dimension getActivity_trace_Dimension();

	/**
	 * Sets the value of the '{@link activitydiagramTrace.States.activitydiagram.TracedActivity#getActivity_trace_Dimension <em>Activity trace Dimension</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @param value the new value of the '<em>Activity trace Dimension</em>' containment reference.
	 * @see #getActivity_trace_Dimension()
	 * @generated
	 */
	void setActivity_trace_Dimension(Activity_trace_Dimension value);
