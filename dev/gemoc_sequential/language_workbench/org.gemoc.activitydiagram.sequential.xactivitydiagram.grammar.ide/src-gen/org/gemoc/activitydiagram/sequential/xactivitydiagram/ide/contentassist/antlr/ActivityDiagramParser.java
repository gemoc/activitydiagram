		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getIntegerVariableAccess().getCurrentValueAssignment_4(), "rule__IntegerVariable__CurrentValueAssignment_4");
					...
					put(grammarAccess.getBooleanVariableAccess().getCurrentValueAssignment_4(), "rule__BooleanVariable__CurrentValueAssignment_4");
					put(grammarAccess.getStaticBooleanValueAccess().getValueAssignment(), "rule__StaticBooleanValue__ValueAssignment");
					put(grammarAccess.getStaticIntegerValueAccess().getValueAssignment(), "rule__StaticIntegerValue__ValueAssignment");
