...
public class ActivityDiagramInputGrammarAccess extends AbstractGrammarElementFinder {
	...
	public class InputElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.modelexecution.operationalsemantics.ActivityDiagramInput.Input");
	...
	public class InputValueElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.modelexecution.operationalsemantics.ActivityDiagramInput.InputValue");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class ValueElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.modelexecution.operationalsemantics.ActivityDiagramInput.Value");
	...
	public class BooleanValueElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.modelexecution.operationalsemantics.ActivityDiagramInput.BooleanValue");
	...
	public class IntegerValueElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.modelexecution.operationalsemantics.ActivityDiagramInput.IntegerValue");
		private final Assignment cValueAssignment = (Assignment)rule.eContents().get(1);
	...
	public class EBooleanElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.modelexecution.operationalsemantics.ActivityDiagramInput.EBoolean");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
	...
	public class EIntElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.modelexecution.operationalsemantics.ActivityDiagramInput.EInt");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class EStringElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.modelexecution.operationalsemantics.ActivityDiagramInput.EString");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
