 ...
 * </p>
 * <ul>
 *   <li>{@link activitydiagramTrace.States.impl.ForkedToken_remainingOffersCount_ValueImpl#getStatesNoOpposite <em>States No Opposite</em>}</li>
...
public class ForkedToken_remainingOffersCount_ValueImpl extends MinimalEObjectImpl.Container implements ForkedToken_remainingOffersCount_Value {
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case StatesPackage.FORKED_TOKEN_REMAINING_OFFERS_COUNT_VALUE__STATES_NO_OPPOSITE:
