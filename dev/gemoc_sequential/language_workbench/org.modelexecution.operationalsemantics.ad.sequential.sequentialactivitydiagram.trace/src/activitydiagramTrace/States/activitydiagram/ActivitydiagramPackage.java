...
public interface ActivitydiagramPackage extends EPackage {
	 ...
	 * @ordered
	 */
	int TRACED_ACTIVITY_NODE__ACTIVITY = TRACED_NAMED_ELEMENT_FEATURE_COUNT + 0;
	 ...
	 * @ordered
	 */
	int TRACED_ACTIVITY_NODE__HELD_TOKENS = TRACED_NAMED_ELEMENT_FEATURE_COUNT + 1;
	 ...
	 * @ordered
	 */
	int TRACED_ACTIVITY_NODE__HELD_TOKENS_SEQUENCE = TRACED_NAMED_ELEMENT_FEATURE_COUNT + 2;
	 ...
	 * @ordered
	 */
	int TRACED_ACTIVITY_NODE__INCOMING = TRACED_NAMED_ELEMENT_FEATURE_COUNT + 3;
	 ...
	 * @ordered
	 */
	int TRACED_ACTIVITY_NODE__OUTGOING = TRACED_NAMED_ELEMENT_FEATURE_COUNT + 4;
	 ...
	 * @ordered
	 */
	int TRACED_ACTIVITY__EDGES = TRACED_NAMED_ELEMENT_FEATURE_COUNT + 0;
	 ...
	 * @ordered
	 */
	int TRACED_ACTIVITY__INPUTS = TRACED_NAMED_ELEMENT_FEATURE_COUNT + 1;
	 ...
	 * @ordered
	 */
	int TRACED_ACTIVITY__NODES = TRACED_NAMED_ELEMENT_FEATURE_COUNT + 3;
	 ...
	 * @ordered
	 */
	int TRACED_ACTIVITY__ORIGINAL_OBJECT = TRACED_NAMED_ELEMENT_FEATURE_COUNT + 4;
	 ...
	 * @ordered
	 */
	int TRACED_ACTIVITY__TRACE = TRACED_NAMED_ELEMENT_FEATURE_COUNT + 5;
	 ...
	 * @ordered
	 */
	int TRACED_ACTIVITY_EDGE__OFFERS = TRACED_NAMED_ELEMENT_FEATURE_COUNT + 0;
	 ...
	 * @ordered
	 */
	int TRACED_ACTIVITY_EDGE__SOURCE = TRACED_NAMED_ELEMENT_FEATURE_COUNT + 2;
	 ...
	 * @ordered
	 */
	int TRACED_ACTIVITY_EDGE__TARGET = TRACED_NAMED_ELEMENT_FEATURE_COUNT + 3;
	 ...
	 * @ordered
	 */
	int TRACED_VARIABLE__CURRENT_VALUE = 0;
	 ...
	 * @ordered
	 */
	int TRACED_VARIABLE__INITIAL_VALUE = 2;
