...
public class StepsPackageImpl extends EPackageImpl implements StepsPackage {
	 ...
	 * @generated
	 */
	private EClass activitydiagram_ActivityNode_SendOffers1_ImplicitStepEClass = null;
	 ...
	 * @generated
	 */
	private EClass activitydiagram_Variable_Execute_AbstractSubStepEClass = null;
	 ...
	 * @generated
	 */
	private EClass activitydiagram_Variable_Execute_ImplicitStepEClass = null;
	 ...
	 * @generated
	 */
	private EClass activitydiagram_Variable_Init_ImplicitStepEClass = null;
	 ...
	 * @generated
	 */
	public EClass getActivitydiagram_ActivityNode_SendOffers1_ImplicitStep() {
		return activitydiagram_ActivityNode_SendOffers1_ImplicitStepEClass;
	}
	 ...
	 * @generated
	 */
	public EReference getActivitydiagram_Variable_Execute_SubSteps() {
	 ...
	 * @generated
	 */
	public EClass getActivitydiagram_Variable_Execute_AbstractSubStep() {
		return activitydiagram_Variable_Execute_AbstractSubStepEClass;
	}
	 ...
	 * @generated
	 */
	public EClass getActivitydiagram_Variable_Execute_ImplicitStep() {
		return activitydiagram_Variable_Execute_ImplicitStepEClass;
	}
	 ...
	 * @generated
	 */
	public EClass getActivitydiagram_Variable_Init_ImplicitStep() {
		return activitydiagram_Variable_Init_ImplicitStepEClass;
	}
	...
	public void createPackageContents() {
		...
		activitydiagram_ActivityNode_SendOffers1_ImplicitStepEClass = createEClass(ACTIVITYDIAGRAM_ACTIVITY_NODE_SEND_OFFERS1_IMPLICIT_STEP);
		...
		createEReference(activitydiagram_Variable_ExecuteEClass, ACTIVITYDIAGRAM_VARIABLE_EXECUTE__SUB_STEPS);
		createEOperation(activitydiagram_Variable_ExecuteEClass, ACTIVITYDIAGRAM_VARIABLE_EXECUTE___GET_CALLER);

		activitydiagram_Variable_Execute_AbstractSubStepEClass = createEClass(ACTIVITYDIAGRAM_VARIABLE_EXECUTE_ABSTRACT_SUB_STEP);

		activitydiagram_Variable_Execute_ImplicitStepEClass = createEClass(ACTIVITYDIAGRAM_VARIABLE_EXECUTE_IMPLICIT_STEP);
		...
		activitydiagram_Variable_Init_ImplicitStepEClass = createEClass(ACTIVITYDIAGRAM_VARIABLE_INIT_IMPLICIT_STEP);
	...
	public void initializePackageContents() {
		...
		activitydiagram_ActivityNode_ExecuteEClass.getESuperTypes().add(this.getActivitydiagram_ActivityNode_Execute_AbstractSubStep());
		...
		activitydiagram_ActivityNode_SendOffers1EClass.getESuperTypes().add(this.getActivitydiagram_ActivityNode_SendOffers1_AbstractSubStep());
		...
		activitydiagram_ActivityNode_SendOffers1_ImplicitStepEClass.getESuperTypes().add(this.getActivitydiagram_ActivityNode_SendOffers1_AbstractSubStep());
		activitydiagram_ActivityNode_SendOffers1_ImplicitStepEClass.getESuperTypes().add(this.getSmallStep());
		...
		activitydiagram_Activity_ExecuteEClass.getESuperTypes().add(this.getActivitydiagram_ActivityNode_Execute_AbstractSubStep());
		activitydiagram_Activity_ExecuteEClass.getESuperTypes().add(this.getActivitydiagram_Activity_Execute_AbstractSubStep());
		...
		activitydiagram_Variable_ExecuteEClass.getESuperTypes().add(this.getActivitydiagram_Variable_Execute_AbstractSubStep());
		activitydiagram_Variable_ExecuteEClass.getESuperTypes().add(this.getBigStep());
		activitydiagram_Variable_Execute_ImplicitStepEClass.getESuperTypes().add(this.getActivitydiagram_Variable_Execute_AbstractSubStep());
		activitydiagram_Variable_Execute_ImplicitStepEClass.getESuperTypes().add(this.getSmallStep());
		activitydiagram_Variable_InitEClass.getESuperTypes().add(this.getActivitydiagram_ActivityNode_Execute_AbstractSubStep());
		activitydiagram_Variable_InitEClass.getESuperTypes().add(this.getActivitydiagram_Activity_Execute_AbstractSubStep());
		activitydiagram_Variable_InitEClass.getESuperTypes().add(this.getActivitydiagram_Variable_Init_AbstractSubStep());
		activitydiagram_Variable_InitEClass.getESuperTypes().add(this.getBigStep());
		activitydiagram_Variable_Init_ImplicitStepEClass.getESuperTypes().add(this.getActivitydiagram_Variable_Init_AbstractSubStep());
		activitydiagram_Variable_Init_ImplicitStepEClass.getESuperTypes().add(this.getSmallStep());
		...
		initEClass(activitydiagram_ActivityNode_SendOffers1_ImplicitStepEClass, Activitydiagram_ActivityNode_SendOffers1_ImplicitStep.class, "Activitydiagram_ActivityNode_SendOffers1_ImplicitStep", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		...
		initEReference(getActivitydiagram_Variable_Execute_SubSteps(), this.getActivitydiagram_Variable_Execute_AbstractSubStep(), null, "subSteps", null, 0, -1, Activitydiagram_Variable_Execute.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEClass(activitydiagram_Variable_Execute_AbstractSubStepEClass, Activitydiagram_Variable_Execute_AbstractSubStep.class, "Activitydiagram_Variable_Execute_AbstractSubStep", IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

		initEClass(activitydiagram_Variable_Execute_ImplicitStepEClass, Activitydiagram_Variable_Execute_ImplicitStep.class, "Activitydiagram_Variable_Execute_ImplicitStep", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		...
		initEClass(activitydiagram_Variable_Init_ImplicitStepEClass, Activitydiagram_Variable_Init_ImplicitStep.class, "Activitydiagram_Variable_Init_ImplicitStep", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
