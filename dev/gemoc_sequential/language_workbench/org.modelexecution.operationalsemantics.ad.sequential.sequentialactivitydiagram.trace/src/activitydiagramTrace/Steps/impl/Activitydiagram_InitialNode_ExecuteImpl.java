...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Activitydiagram Initial Node Execute</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link activitydiagramTrace.Steps.impl.Activitydiagram_InitialNode_ExecuteImpl#getEndingState <em>Ending State</em>}</li>
 *   <li>{@link activitydiagramTrace.Steps.impl.Activitydiagram_InitialNode_ExecuteImpl#getStartingState <em>Starting State</em>}</li>
 *   <li>{@link activitydiagramTrace.Steps.impl.Activitydiagram_InitialNode_ExecuteImpl#getSubSteps <em>Sub Steps</em>}</li>
 * </ul>
 *
 * @generated
 */
public class Activitydiagram_InitialNode_ExecuteImpl extends StepImpl implements Activitydiagram_InitialNode_Execute {
	/**
	 ...
	 * @ordered
	 */
	protected EList<Activitydiagram_InitialNode_Execute_AbstractSubStep> subSteps;
	 ...
	 * @generated
	 */
	protected Activitydiagram_InitialNode_ExecuteImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return StepsPackage.Literals.ACTIVITYDIAGRAM_INITIAL_NODE_EXECUTE;
	}
		...
		if (endingState != null && endingState.eIsProxy()) {
			...
			if (endingState != oldEndingState) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, StepsPackage.ACTIVITYDIAGRAM_INITIAL_NODE_EXECUTE__ENDING_STATE, oldEndingState, endingState));
			}
		}
		return endingState;
	}
	...
	public NotificationChain basicSetEndingState(State newEndingState, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, StepsPackage.ACTIVITYDIAGRAM_INITIAL_NODE_EXECUTE__ENDING_STATE, oldEndingState, newEndingState);
	...
	public void setEndingState(State newEndingState) {
		if (newEndingState != endingState) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, StepsPackage.ACTIVITYDIAGRAM_INITIAL_NODE_EXECUTE__ENDING_STATE, newEndingState, newEndingState));
	}
	...
	public State getStartingState() {
		if (startingState != null && startingState.eIsProxy()) {
			...
			if (startingState != oldStartingState) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, StepsPackage.ACTIVITYDIAGRAM_INITIAL_NODE_EXECUTE__STARTING_STATE, oldStartingState, startingState));
			}
		}
	...
	public NotificationChain basicSetStartingState(State newStartingState, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, StepsPackage.ACTIVITYDIAGRAM_INITIAL_NODE_EXECUTE__STARTING_STATE, oldStartingState, newStartingState);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setStartingState(State newStartingState) {
		if (newStartingState != startingState) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, StepsPackage.ACTIVITYDIAGRAM_INITIAL_NODE_EXECUTE__STARTING_STATE, newStartingState, newStartingState));
	}
	 ...
	 * @generated
	 */
	public EList<Activitydiagram_InitialNode_Execute_AbstractSubStep> getSubSteps() {
		if (subSteps == null) {
			subSteps = new EObjectContainmentEList<Activitydiagram_InitialNode_Execute_AbstractSubStep>(Activitydiagram_InitialNode_Execute_AbstractSubStep.class, this, StepsPackage.ACTIVITYDIAGRAM_INITIAL_NODE_EXECUTE__SUB_STEPS);
		}
		return subSteps;
	}
	 ...
	 * @generated
	 */
	public TracedInitialNode getCaller() {
		return (activitydiagramTrace.States.activitydiagram.TracedInitialNode) this.getMseoccurrence().getMse().getCaller();
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case StepsPackage.ACTIVITYDIAGRAM_INITIAL_NODE_EXECUTE__ENDING_STATE:
				if (endingState != null)
					msgs = ((InternalEObject)endingState).eInverseRemove(this, StatesPackage.STATE__ENDED_STEPS, State.class, msgs);
				return basicSetEndingState((State)otherEnd, msgs);
			case StepsPackage.ACTIVITYDIAGRAM_INITIAL_NODE_EXECUTE__STARTING_STATE:
				if (startingState != null)
					msgs = ((InternalEObject)startingState).eInverseRemove(this, StatesPackage.STATE__STARTED_STEPS, State.class, msgs);
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case StepsPackage.ACTIVITYDIAGRAM_INITIAL_NODE_EXECUTE__SUB_STEPS:
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case StepsPackage.ACTIVITYDIAGRAM_INITIAL_NODE_EXECUTE__SUB_STEPS:
				getSubSteps().clear();
				getSubSteps().addAll((Collection<? extends Activitydiagram_InitialNode_Execute_AbstractSubStep>)newValue);
				return;
		}
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == BigStep.class) {
			switch (derivedFeatureID) {
				case StepsPackage.ACTIVITYDIAGRAM_INITIAL_NODE_EXECUTE__SUB_STEPS: return MsePackage.BIG_STEP__SUB_STEPS;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == BigStep.class) {
			switch (baseFeatureID) {
				case MsePackage.BIG_STEP__SUB_STEPS: return StepsPackage.ACTIVITYDIAGRAM_INITIAL_NODE_EXECUTE__SUB_STEPS;
				default: return -1;
			}
		}
		if (baseClass == SequentialStep.class) {
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case StepsPackage.ACTIVITYDIAGRAM_INITIAL_NODE_EXECUTE___GET_CALLER:
				return getCaller();
		}
		return super.eInvoke(operationID, arguments);
	}

} //Activitydiagram_InitialNode_ExecuteImpl
