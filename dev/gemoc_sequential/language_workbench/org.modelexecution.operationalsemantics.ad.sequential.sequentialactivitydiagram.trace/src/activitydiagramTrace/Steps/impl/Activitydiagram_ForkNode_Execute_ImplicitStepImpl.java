...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Activitydiagram Fork Node Execute Implicit Step</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link activitydiagramTrace.Steps.impl.Activitydiagram_ForkNode_Execute_ImplicitStepImpl#getEndingState <em>Ending State</em>}</li>
 *   <li>{@link activitydiagramTrace.Steps.impl.Activitydiagram_ForkNode_Execute_ImplicitStepImpl#getStartingState <em>Starting State</em>}</li>
 * </ul>
 *
 * @generated
 */
public class Activitydiagram_ForkNode_Execute_ImplicitStepImpl extends StepImpl implements Activitydiagram_ForkNode_Execute_ImplicitStep {
	/**
	 ...
	 * @generated
	 */
	protected Activitydiagram_ForkNode_Execute_ImplicitStepImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return StepsPackage.Literals.ACTIVITYDIAGRAM_FORK_NODE_EXECUTE_IMPLICIT_STEP;
	}
		...
		if (endingState != null && endingState.eIsProxy()) {
			...
			if (endingState != oldEndingState) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, StepsPackage.ACTIVITYDIAGRAM_FORK_NODE_EXECUTE_IMPLICIT_STEP__ENDING_STATE, oldEndingState, endingState));
			}
		}
		return endingState;
	}
	...
	public NotificationChain basicSetEndingState(State newEndingState, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, StepsPackage.ACTIVITYDIAGRAM_FORK_NODE_EXECUTE_IMPLICIT_STEP__ENDING_STATE, oldEndingState, newEndingState);
	...
	public void setEndingState(State newEndingState) {
		if (newEndingState != endingState) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, StepsPackage.ACTIVITYDIAGRAM_FORK_NODE_EXECUTE_IMPLICIT_STEP__ENDING_STATE, newEndingState, newEndingState));
	}
	...
	public State getStartingState() {
		if (startingState != null && startingState.eIsProxy()) {
			...
			if (startingState != oldStartingState) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, StepsPackage.ACTIVITYDIAGRAM_FORK_NODE_EXECUTE_IMPLICIT_STEP__STARTING_STATE, oldStartingState, startingState));
			}
		}
	...
	public NotificationChain basicSetStartingState(State newStartingState, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, StepsPackage.ACTIVITYDIAGRAM_FORK_NODE_EXECUTE_IMPLICIT_STEP__STARTING_STATE, oldStartingState, newStartingState);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setStartingState(State newStartingState) {
		if (newStartingState != startingState) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, StepsPackage.ACTIVITYDIAGRAM_FORK_NODE_EXECUTE_IMPLICIT_STEP__STARTING_STATE, newStartingState, newStartingState));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case StepsPackage.ACTIVITYDIAGRAM_FORK_NODE_EXECUTE_IMPLICIT_STEP__ENDING_STATE:
				if (endingState != null)
					msgs = ((InternalEObject)endingState).eInverseRemove(this, StatesPackage.STATE__ENDED_STEPS, State.class, msgs);
				return basicSetEndingState((State)otherEnd, msgs);
			case StepsPackage.ACTIVITYDIAGRAM_FORK_NODE_EXECUTE_IMPLICIT_STEP__STARTING_STATE:
				if (startingState != null)
					msgs = ((InternalEObject)startingState).eInverseRemove(this, StatesPackage.STATE__STARTED_STEPS, State.class, msgs);
...
} //Activitydiagram_ForkNode_Execute_ImplicitStepImpl
