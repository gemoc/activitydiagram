...
public class StepsFactoryImpl extends EFactoryImpl implements StepsFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			...
			case StepsPackage.ACTIVITYDIAGRAM_ACTIVITY_NODE_SEND_OFFERS1_IMPLICIT_STEP: return createActivitydiagram_ActivityNode_SendOffers1_ImplicitStep();
			...
			case StepsPackage.ACTIVITYDIAGRAM_VARIABLE_EXECUTE_IMPLICIT_STEP: return createActivitydiagram_Variable_Execute_ImplicitStep();
			case StepsPackage.ACTIVITYDIAGRAM_VARIABLE_INIT: return createActivitydiagram_Variable_Init();
			case StepsPackage.ACTIVITYDIAGRAM_VARIABLE_INIT_IMPLICIT_STEP: return createActivitydiagram_Variable_Init_ImplicitStep();
	 ...
	 * @generated
	 */
	public Activitydiagram_ActivityNode_SendOffers1_ImplicitStep createActivitydiagram_ActivityNode_SendOffers1_ImplicitStep() {
		Activitydiagram_ActivityNode_SendOffers1_ImplicitStepImpl activitydiagram_ActivityNode_SendOffers1_ImplicitStep = new Activitydiagram_ActivityNode_SendOffers1_ImplicitStepImpl();
		return activitydiagram_ActivityNode_SendOffers1_ImplicitStep;
	}
	 ...
	 * @generated
	 */
	public Activitydiagram_Variable_Execute_ImplicitStep createActivitydiagram_Variable_Execute_ImplicitStep() {
		Activitydiagram_Variable_Execute_ImplicitStepImpl activitydiagram_Variable_Execute_ImplicitStep = new Activitydiagram_Variable_Execute_ImplicitStepImpl();
		return activitydiagram_Variable_Execute_ImplicitStep;
	}
	 ...
	 * @generated
	 */
	public Activitydiagram_Variable_Init_ImplicitStep createActivitydiagram_Variable_Init_ImplicitStep() {
		Activitydiagram_Variable_Init_ImplicitStepImpl activitydiagram_Variable_Init_ImplicitStep = new Activitydiagram_Variable_Init_ImplicitStepImpl();
		return activitydiagram_Variable_Init_ImplicitStep;
	}
