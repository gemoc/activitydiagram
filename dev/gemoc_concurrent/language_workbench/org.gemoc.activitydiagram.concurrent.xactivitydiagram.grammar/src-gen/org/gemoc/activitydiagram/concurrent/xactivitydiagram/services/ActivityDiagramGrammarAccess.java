 ...
 * generated by Xtext
 */
package org.gemoc.activitydiagram.concurrent.xactivitydiagram.services;
...
public class ActivityDiagramGrammarAccess extends AbstractGrammarElementFinder {
	...
	public class ActivityElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.gemoc.activitydiagram.concurrent.xactivitydiagram.ActivityDiagram.Activity");
	...
	public class ActivityNodeElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.gemoc.activitydiagram.concurrent.xactivitydiagram.ActivityDiagram.ActivityNode");
	...
	public class ActivityEdgeElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.gemoc.activitydiagram.concurrent.xactivitydiagram.ActivityDiagram.ActivityEdge");
	...
	public class VariableElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.gemoc.activitydiagram.concurrent.xactivitydiagram.ActivityDiagram.Variable");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
	...
	public class ExpressionElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.gemoc.activitydiagram.concurrent.xactivitydiagram.ActivityDiagram.Expression");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
	...
	public class ValueElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.gemoc.activitydiagram.concurrent.xactivitydiagram.ActivityDiagram.Value");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
	...
	public class EStringElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.gemoc.activitydiagram.concurrent.xactivitydiagram.ActivityDiagram.EString");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
	...
	public class OpaqueActionElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.gemoc.activitydiagram.concurrent.xactivitydiagram.ActivityDiagram.OpaqueAction");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class InitialNodeElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.gemoc.activitydiagram.concurrent.xactivitydiagram.ActivityDiagram.InitialNode");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class ActivityFinalNodeElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.gemoc.activitydiagram.concurrent.xactivitydiagram.ActivityDiagram.ActivityFinalNode");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class ForkNodeElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.gemoc.activitydiagram.concurrent.xactivitydiagram.ActivityDiagram.ForkNode");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class JoinNodeElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.gemoc.activitydiagram.concurrent.xactivitydiagram.ActivityDiagram.JoinNode");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class MergeNodeElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.gemoc.activitydiagram.concurrent.xactivitydiagram.ActivityDiagram.MergeNode");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class DecisionNodeElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.gemoc.activitydiagram.concurrent.xactivitydiagram.ActivityDiagram.DecisionNode");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class IntegerCalculationExpressionElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.gemoc.activitydiagram.concurrent.xactivitydiagram.ActivityDiagram.IntegerCalculationExpression");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class IntegerComparisonExpressionElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.gemoc.activitydiagram.concurrent.xactivitydiagram.ActivityDiagram.IntegerComparisonExpression");
		private final Group cGroup = (Group)rule.eContents().get(1);
		private final Assignment cAssigneeAssignment_0 = (Assignment)cGroup.eContents().get(0);
	...
	public class BooleanUnaryExpressionElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.gemoc.activitydiagram.concurrent.xactivitydiagram.ActivityDiagram.BooleanUnaryExpression");
		private final Group cGroup = (Group)rule.eContents().get(1);
		private final Assignment cAssigneeAssignment_0 = (Assignment)cGroup.eContents().get(0);
		private final CrossReference cAssigneeBooleanVariableCrossReference_0_0 = (CrossReference)cAssigneeAssignment_0.eContents().get(0);
		private final RuleCall cAssigneeBooleanVariableIDTerminalRuleCall_0_0_1 = (RuleCall)cAssigneeBooleanVariableCrossReference_0_0.eContents().get(1);
	...
	public class BooleanBinaryExpressionElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.gemoc.activitydiagram.concurrent.xactivitydiagram.ActivityDiagram.BooleanBinaryExpression");
		private final Group cGroup = (Group)rule.eContents().get(1);
		private final Assignment cAssigneeAssignment_0 = (Assignment)cGroup.eContents().get(0);
		private final CrossReference cAssigneeBooleanVariableCrossReference_0_0 = (CrossReference)cAssigneeAssignment_0.eContents().get(0);
		private final RuleCall cAssigneeBooleanVariableIDTerminalRuleCall_0_0_1 = (RuleCall)cAssigneeBooleanVariableCrossReference_0_0.eContents().get(1);
	...
	public class IntegerVariableElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.gemoc.activitydiagram.concurrent.xactivitydiagram.ActivityDiagram.IntegerVariable");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class BooleanVariableElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.gemoc.activitydiagram.concurrent.xactivitydiagram.ActivityDiagram.BooleanVariable");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class BooleanValueElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.gemoc.activitydiagram.concurrent.xactivitydiagram.ActivityDiagram.BooleanValue");
	...
	public class IntegerValueElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.gemoc.activitydiagram.concurrent.xactivitydiagram.ActivityDiagram.IntegerValue");
		private final Assignment cValueAssignment = (Assignment)rule.eContents().get(1);
	...
	public class EBooleanElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.gemoc.activitydiagram.concurrent.xactivitydiagram.ActivityDiagram.EBoolean");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
	...
	public class EIntElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.gemoc.activitydiagram.concurrent.xactivitydiagram.ActivityDiagram.EInt");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class ControlFlowElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.gemoc.activitydiagram.concurrent.xactivitydiagram.ActivityDiagram.ControlFlow");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class IntegerCalculationOperatorElements extends AbstractEnumRuleElementFinder {
		private final EnumRule rule = (EnumRule) GrammarUtil.findRuleForName(getGrammar(), "org.gemoc.activitydiagram.concurrent.xactivitydiagram.ActivityDiagram.IntegerCalculationOperator");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
	...
	public class IntegerComparisonOperatorElements extends AbstractEnumRuleElementFinder {
		private final EnumRule rule = (EnumRule) GrammarUtil.findRuleForName(getGrammar(), "org.gemoc.activitydiagram.concurrent.xactivitydiagram.ActivityDiagram.IntegerComparisonOperator");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
	...
	public class BooleanUnaryOperatorElements extends AbstractEnumRuleElementFinder {
		private final EnumRule rule = (EnumRule) GrammarUtil.findRuleForName(getGrammar(), "org.gemoc.activitydiagram.concurrent.xactivitydiagram.ActivityDiagram.BooleanUnaryOperator");
	...
	public class BooleanBinaryOperatorElements extends AbstractEnumRuleElementFinder {
		private final EnumRule rule = (EnumRule) GrammarUtil.findRuleForName(getGrammar(), "org.gemoc.activitydiagram.concurrent.xactivitydiagram.ActivityDiagram.BooleanBinaryOperator");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
	...
	protected Grammar internalFindGrammar(GrammarProvider grammarProvider) {
		...
		while (grammar != null) {
			if ("org.gemoc.activitydiagram.concurrent.xactivitydiagram.ActivityDiagram".equals(grammar.getName())) {
				return grammar;
			}
