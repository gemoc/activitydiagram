...
public class TraceAspect {
  public static EList<ActivityNode> executedNodes(final Trace _self) {
    final org.gemoc.activitydiagram.concurrent.xactivitydiagram.aspects.TraceAspectTraceAspectProperties _self_ = org.gemoc.activitydiagram.concurrent.xactivitydiagram.aspects.TraceAspectTraceAspectContext.getSelf(_self);
    Object result = null;
    result = _privk3_executedNodes(_self_, _self);;
    return (org.eclipse.emf.common.util.EList<org.gemoc.activitydiagram.concurrent.xactivitydiagram.activitydiagram.ActivityNode>)result;
  }
