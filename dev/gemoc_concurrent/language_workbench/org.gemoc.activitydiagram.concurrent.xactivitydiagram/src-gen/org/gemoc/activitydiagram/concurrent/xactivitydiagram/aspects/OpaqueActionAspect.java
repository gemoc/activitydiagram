...
public class OpaqueActionAspect extends ActivityNodeAspect {
  ...
  public static void execute(final OpaqueAction _self) {
    final org.gemoc.activitydiagram.concurrent.xactivitydiagram.aspects.OpaqueActionAspectOpaqueActionAspectProperties _self_ = org.gemoc.activitydiagram.concurrent.xactivitydiagram.aspects.OpaqueActionAspectOpaqueActionAspectContext.getSelf(_self);
     if (_self instanceof org.gemoc.activitydiagram.concurrent.xactivitydiagram.activitydiagram.OpaqueAction){
    					org.gemoc.activitydiagram.concurrent.xactivitydiagram.aspects.OpaqueActionAspect._privk3_execute(_self_, (org.gemoc.activitydiagram.concurrent.xactivitydiagram.activitydiagram.OpaqueAction)_self);
