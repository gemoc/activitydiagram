...
public class BooleanBinaryExpressionAspect extends ExpressionAspect {
  ...
  public static void execute(final BooleanBinaryExpression _self) {
    final org.gemoc.activitydiagram.concurrent.xactivitydiagram.aspects.BooleanBinaryExpressionAspectBooleanBinaryExpressionAspectProperties _self_ = org.gemoc.activitydiagram.concurrent.xactivitydiagram.aspects.BooleanBinaryExpressionAspectBooleanBinaryExpressionAspectContext.getSelf(_self);
     if (_self instanceof org.gemoc.activitydiagram.concurrent.xactivitydiagram.activitydiagram.BooleanBinaryExpression){
    					org.gemoc.activitydiagram.concurrent.xactivitydiagram.aspects.BooleanBinaryExpressionAspect._privk3_execute(_self_, (org.gemoc.activitydiagram.concurrent.xactivitydiagram.activitydiagram.BooleanBinaryExpression)_self);
