...
/**
 * This is the item provider adapter for a {@link org.gemoc.activitydiagram.concurrent.xactivitydiagram.activitydiagram.Context} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ContextItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Context_output_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Context_output_feature", "_UI_Context_type"),
				 ActivitydiagramPackage.Literals.CONTEXT__OUTPUT,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addActivityPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Context_activity_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Context_activity_feature", "_UI_Context_type"),
				 ActivitydiagramPackage.Literals.CONTEXT__ACTIVITY,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addNodePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Context_node_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Context_node_feature", "_UI_Context_type"),
				 ActivitydiagramPackage.Literals.CONTEXT__NODE,
				 true,
				 false,
				 true,
				 null,
	...
	public ResourceLocator getResourceLocator() {
		return XActivityDiagramEditPlugin.INSTANCE;
	}
