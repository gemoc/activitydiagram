...
/**
 * This is the item provider adapter for a {@link org.gemoc.activitydiagram.concurrent.xactivitydiagram.activitydiagram.Activity} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ActivityItemProvider extends NamedElementItemProvider {
	...
	protected void addContextPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Activity_context_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Activity_context_feature", "_UI_Activity_type"),
				 ActivitydiagramPackage.Literals.ACTIVITY__CONTEXT,
				 true,
				 false,
				 true,
				 null,
		...
		newChildDescriptors.add
			(createChildParameter
				(ActivitydiagramPackage.Literals.ACTIVITY__LOCALS,
				 ActivitydiagramFactory.eINSTANCE.createVariable()));
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify =
			childFeature == ActivitydiagramPackage.Literals.ACTIVITY__LOCALS ||
			childFeature == ActivitydiagramPackage.Literals.ACTIVITY__INPUTS;
