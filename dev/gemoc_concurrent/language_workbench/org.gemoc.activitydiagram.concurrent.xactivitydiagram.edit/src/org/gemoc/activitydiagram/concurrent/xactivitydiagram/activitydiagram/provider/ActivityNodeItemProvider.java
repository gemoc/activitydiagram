...
/**
 * This is the item provider adapter for a {@link org.gemoc.activitydiagram.concurrent.xactivitydiagram.activitydiagram.ActivityNode} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ActivityNodeItemProvider extends NamedElementItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ActivitydiagramPackage.Literals.ACTIVITY_NODE__OUTGOING,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ActivitydiagramPackage.Literals.ACTIVITY_NODE__INCOMING,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addRunningPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ActivityNode_running_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ActivityNode_running_feature", "_UI_ActivityNode_type"),
				 ActivitydiagramPackage.Literals.ACTIVITY_NODE__RUNNING,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ActivitydiagramPackage.Literals.ACTIVITY_NODE__HELD_TOKENS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ActivitydiagramPackage.Literals.ACTIVITY_NODE__HELD_TOKENS,
				 ActivitydiagramFactory.eINSTANCE.createToken()));
		...
		newChildDescriptors.add
			(createChildParameter
				(ActivitydiagramPackage.Literals.ACTIVITY_NODE__HELD_TOKENS,
				 ActivitydiagramFactory.eINSTANCE.createForkedToken()));
	}
