...
public class ActivityDiagramInputGrammarAccess extends AbstractGrammarElementFinder {
	...
	public class InputElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.gemoc.activitydiagram.concurrent.xactivitydiagram.ActivityDiagramInput.Input");
	...
	public class InputValueElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.gemoc.activitydiagram.concurrent.xactivitydiagram.ActivityDiagramInput.InputValue");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class ValueElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.gemoc.activitydiagram.concurrent.xactivitydiagram.ActivityDiagramInput.Value");
	...
	public class BooleanValueElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.gemoc.activitydiagram.concurrent.xactivitydiagram.ActivityDiagramInput.BooleanValue");
	...
	public class IntegerValueElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.gemoc.activitydiagram.concurrent.xactivitydiagram.ActivityDiagramInput.IntegerValue");
		private final Assignment cValueAssignment = (Assignment)rule.eContents().get(1);
	...
	public class EBooleanElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.gemoc.activitydiagram.concurrent.xactivitydiagram.ActivityDiagramInput.EBoolean");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
	...
	public class EIntElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.gemoc.activitydiagram.concurrent.xactivitydiagram.ActivityDiagramInput.EInt");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class EStringElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.gemoc.activitydiagram.concurrent.xactivitydiagram.ActivityDiagramInput.EString");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
	...
	protected Grammar internalFindGrammar(GrammarProvider grammarProvider) {
		...
		while (grammar != null) {
			if ("org.gemoc.activitydiagram.concurrent.xactivitydiagram.ActivityDiagramInput".equals(grammar.getName())) {
				return grammar;
			}
