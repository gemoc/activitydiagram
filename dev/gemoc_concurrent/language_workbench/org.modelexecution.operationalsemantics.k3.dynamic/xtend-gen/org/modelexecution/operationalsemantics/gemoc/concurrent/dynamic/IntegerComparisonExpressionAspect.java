...
public class IntegerComparisonExpressionAspect extends ExpressionAspect {
  ...
  public static void execute(final IntegerComparisonExpression _self) {
    org.modelexecution.operationalsemantics.gemoc.concurrent.dynamic.IntegerComparisonExpressionAspectIntegerComparisonExpressionAspectProperties _self_ = org.modelexecution.operationalsemantics.gemoc.concurrent.dynamic.IntegerComparisonExpressionAspectIntegerComparisonExpressionAspectContext.getSelf(_self);
     if (_self instanceof activitydiagram.IntegerComparisonExpression){
     org.modelexecution.operationalsemantics.gemoc.concurrent.dynamic.IntegerComparisonExpressionAspect._privk3_execute(_self_, (activitydiagram.IntegerComparisonExpression)_self);
