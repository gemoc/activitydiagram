...
public class ExpressionAspectExpressionAspectContext {
  ...
  public static ExpressionAspectExpressionAspectProperties getSelf(final Expression _self) {
    		if (!INSTANCE.map.containsKey(_self))
    			INSTANCE.map.put(_self, new org.modelexecution.operationalsemantics.gemoc.concurrent.dynamic.ExpressionAspectExpressionAspectProperties());
    		return INSTANCE.map.get(_self);
  }
  
  private Map<Expression, ExpressionAspectExpressionAspectProperties> map = new java.util.WeakHashMap<activitydiagram.Expression, org.modelexecution.operationalsemantics.gemoc.concurrent.dynamic.ExpressionAspectExpressionAspectProperties>();
