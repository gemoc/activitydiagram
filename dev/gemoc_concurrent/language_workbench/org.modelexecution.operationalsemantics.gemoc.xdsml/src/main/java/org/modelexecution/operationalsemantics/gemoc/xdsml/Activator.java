package org.modelexecution.operationalsemantics.gemoc.xdsml;
...
public class Activator extends GemocUIPlugin {
	...
	// The plug-in ID
	public static final String PLUGIN_ID = "org.modelexecution.operationalsemantics.gemoc.xdsml"; //$NON-NLS-1$
