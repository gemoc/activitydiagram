...
//		var activity = getActivityfromXMI(inputPath)
	...
	def static void main(Activity activity) {
		...
		try{
			...
			println("not able to find companion input variable files : Ignoring")
		}
		var start = System.nanoTime;
		activity.main1(inputValues);
		var stop = System.nanoTime;
...
class ActivityEdgeAspect extends NamedElementAspect {
	...
	def boolean hasOffer1() {
		return _self.offers1.exists[o1|o1.hasTokens()]
	}
